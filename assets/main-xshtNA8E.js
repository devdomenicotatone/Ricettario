const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/logo-intro-Cp8JEbss.css","assets/pagina-CpfCwZLO.js","assets/pagina-CWlLvqi1.css"])))=>i.map(i=>d[i]);
(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const a of document.querySelectorAll('link[rel="modulepreload"]'))i(a);new MutationObserver(a=>{for(const r of a)if(r.type==="childList")for(const n of r.addedNodes)n.tagName==="LINK"&&n.rel==="modulepreload"&&i(n)}).observe(document,{childList:!0,subtree:!0});function o(a){const r={};return a.integrity&&(r.integrity=a.integrity),a.referrerPolicy&&(r.referrerPolicy=a.referrerPolicy),a.crossOrigin==="use-credentials"?r.credentials="include":a.crossOrigin==="anonymous"?r.credentials="omit":r.credentials="same-origin",r}function i(a){if(a.ep)return;a.ep=!0;const r=o(a);fetch(a.href,r)}})();const le="modulepreload",de=function(e){return"/Ricettario/"+e},z={},j=function(t,o,i){let a=Promise.resolve();if(o&&o.length>0){let n=function(g){return Promise.all(g.map(f=>Promise.resolve(f).then(_=>({status:"fulfilled",value:_}),_=>({status:"rejected",reason:_}))))};document.getElementsByTagName("link");const s=document.querySelector("meta[property=csp-nonce]"),c=s?.nonce||s?.getAttribute("nonce");a=n(o.map(g=>{if(g=de(g),g in z)return;z[g]=!0;const f=g.endsWith(".css"),_=f?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${g}"]${_}`))return;const l=document.createElement("link");if(l.rel=f?"stylesheet":le,f||(l.as="script"),l.crossOrigin="",l.href=g,c&&l.setAttribute("nonce",c),document.head.appendChild(l),f)return new Promise((b,d)=>{l.addEventListener("load",b),l.addEventListener("error",()=>d(new Error(`Unable to preload CSS for ${g}`)))})}))}function r(n){const s=new Event("vite:preloadError",{cancelable:!0});if(s.payload=n,window.dispatchEvent(s),!s.defaultPrevented)throw n}return a.then(n=>{for(const s of n||[])s.status==="rejected"&&r(s.reason);return t().catch(r)})},h="/Ricettario/";let N={};function pe(e){N=e}function G(e){let t=e.replace(h,"").replace(/^\/+|\/+$/g,"");if(!t||t==="index.html")return{type:"home",params:{}};const o=t.match(/^ricette\/([^/]+)\/([^/]+?)(?:\.html)?$/);if(o)return{type:"recipe",params:{category:o[1],slug:o[2]}};const i=t.match(/^ricette\/([^/]+)\/?$/);if(i)return{type:"category",params:{category:i[1]}};const a=t.match(/^cottura(?:\/([^/]+?))?(?:\.html)?$/);return a?{type:"cottura",params:{config:a[1]||null}}:{type:"home",params:{}}}async function M(e,t=!0){const o=new URL(e,window.location.origin);t&&history.pushState(null,"",o.pathname+o.search);const i=G(o.pathname),a=document.getElementById("app");a&&(window.scrollTo(0,0),"startViewTransition"in document?document.startViewTransition(async()=>{await O(i,a)}):await O(i,a))}async function O(e,t){const o=N[e.type];o?await o(t,e.params):t.innerHTML=`<div class="container" style="padding: 80px 0; text-align: center;">
      <h2>Pagina non trovata</h2>
      <p><a href="${h}" data-link>← Torna alla Home</a></p>
    </div>`,P()}function P(){const e=document.querySelectorAll(".reveal:not(.visible)");if(e.length===0)return;const t=new IntersectionObserver(o=>{o.forEach(i=>{i.isIntersecting&&(i.target.classList.add("visible"),t.unobserve(i.target))})},{threshold:.1,rootMargin:"0px 0px -50px 0px"});e.forEach(o=>t.observe(o))}function ge(){const e=sessionStorage.getItem("spa-redirect");e&&(sessionStorage.removeItem("spa-redirect"),history.replaceState(null,"",e)),document.addEventListener("click",t=>{const o=t.target.closest("a[href]");if(!o)return;const i=o.getAttribute("href"),a=o.getAttribute("data-nav-section");if(a){if(G(window.location.pathname).type!=="home"){t.preventDefault(),M(h).then(()=>{setTimeout(()=>{const s=document.getElementById(a);s&&s.scrollIntoView({behavior:"smooth"})},100)});return}return}if(!i||i.startsWith("http")||i.startsWith("#")||i.startsWith("mailto:")||i.startsWith("tel:")||o.target==="_blank")return;t.preventDefault();const r=new URL(i,window.location.href);M(r.href)}),window.addEventListener("popstate",()=>{M(window.location.href,!1)}),M(window.location.href,!1)}function V(e){const t=e.replace(/\.(jpg|jpeg|png|webp)$/i,"");return{avif:`${t}.avif`,webp:`${t}.webp`}}function W(e,t,o="",i="lazy"){if(!e)return"";const{avif:a,webp:r}=V(e),n=o?` class="${o}"`:"",s=i?` loading="${i}"`:"";return`<picture>
...
</picture>`}const U="ricettario_fatte";function D(){try{const e=localStorage.getItem(U);return e?new Set(JSON.parse(e)):new Set}catch{return new Set}}function he(e){localStorage.setItem(U,JSON.stringify([...e]))}function me(e){return D().has(e)}function fe(e){const t=D(),o=!t.has(e);return o?t.add(e):t.delete(e),he(t),o}function I(){const e=D();if(e.size===0)return;document.querySelectorAll(".recipe-card--compact, .category-card").forEach(o=>{const i=o.getAttribute("href")||"",a=new URL(i,location.origin).pathname.split("/").filter(Boolean).pop();if(a&&e.has(a)&&!o.querySelector(".made-badge")){const r=document.createElement("span");r.className="made-badge",r.textContent="✓",r.title="Ricetta già fatta!";const n=o.querySelector(".recipe-card--compact__image-wrapper, .category-card__image-wrapper");n&&n.appendChild(r)}})}function _e(e){const t=document.getElementById("made-toggle");if(!t)return;const o=i=>{t.classList.toggle("made-toggle--active",i),t.innerHTML=i?'<span class="made-toggle__icon">✓</span> <span class="made-toggle__label">Fatta!</span>':'<span class="made-toggle__icon">○</span> <span class="made-toggle__label">Segna come fatta</span>',t.title=i?"Clicca per rimuovere":"Segna questa ricetta come fatta"};o(me(e)),t.addEventListener("click",i=>{i.preventDefault();const a=fe(e);o(a),t.classList.add("made-toggle--pop"),setTimeout(()=>t.classList.remove("made-toggle--pop"),400)})}const ye={"arrow-up-right":'<path d="M7 7h10v10"/><path d="M7 17 17 7"/>',"chevron-down":'<path d="m6 9 6 6 6-6"/>',"grid-3x3":'<rect width="18" height="18" x="3" y="3" rx="2"/><path d="M3 9h18"/><path d="M3 15h18"/><path d="M9 3v18"/><path d="M15 3v18"/>',list:'<path d="M3 5h.01"/><path d="M3 12h.01"/><path d="M3 19h.01"/><path d="M8 5h13"/><path d="M8 12h13"/><path d="M8 19h13"/>',microscope:'<path d="M6 18h8"/><path d="M3 22h18"/><path d="M14 22a7 7 0 1 0 0-14h-1"/><path d="M9 14h2"/><path d="M9 12a2 2 0 0 1-2-2V6h6v4a2 2 0 0 1-2 2Z"/><path d="M12 6V3a1 1 0 0 0-1-1H9a1 1 0 0 0-1 1v3"/>',moon:'<path d="M20.985 12.486a9 9 0 1 1-9.473-9.472c.405-.022.617.46.402.803a6 6 0 0 0 8.268 8.268c.344-.215.825-.004.803.401"/>',search:'<path d="m21 21-4.34-4.34"/><circle cx="11" cy="11" r="8"/>',sun:'<circle cx="12" cy="12" r="4"/><path d="M12 2v2"/><path d="M12 20v2"/><path d="m4.93 4.93 1.41 1.41"/><path d="m17.66 17.66 1.41 1.41"/><path d="M2 12h2"/><path d="M20 12h2"/><path d="m6.34 17.66-1.41 1.41"/><path d="m19.07 4.93-1.41 1.41"/>'},X="http://www.w3.org/2000/svg",ve={xmlns:X,width:"24",height:"24",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor","stroke-width":"2","stroke-linecap":"round","stroke-linejoin":"round"};function be(e=document){for(const t of e.querySelectorAll("[data-lucide]")){const o=t.getAttribute("data-lucide"),i=ye[o];if(!i){console.warn(`[icons] icona "${o}" non disponibile: aggiungila a js/icons.js`);continue}const a=document.createElementNS(X,"svg");for(const[r,n]of Object.entries(ve))a.setAttribute(r,n);for(const r of t.attributes)r.name!=="data-lucide"&&a.setAttribute(r.name,r.value);a.setAttribute("class",`lucide lucide-${o}${t.className?" "+t.className:""}`),a.innerHTML=i,t.replaceWith(a)}}const R={pane:{name:"Pane",dir:"pane",emoji:"baguette-bread",unicode:"🥖",title:"Pane Artigianale",desc:"Ricette di pane ad alta idratazione — ciabatta, filone, baguette e pane speciale."},pizza:{name:"Pizza",dir:"pizza",emoji:"pizza",unicode:"🍕",title:"Pizza Artigianale",desc:"Pizze con lievitazione lunga — napoletana, in teglia, canotto e pinsa romana."},primi:{name:"Primi",dir:"primi",emoji:"tomato",unicode:"🥣",title:"Primi Piatti",desc:"Primi piatti della tradizione — gnocchi, polenta, zuppe e piatti unici caldi."},lievitati:{name:"Lievitati",dir:"lievitati",emoji:"croissant",unicode:"🥐",title:"Lievitati Dolci e Salati",desc:"Brioche, cornetti, panettone, burger buns e rosticceria."},focaccia:{name:"Focaccia",dir:"focaccia",emoji:"flatbread",unicode:"🫓",title:"Focaccia Artigianale",desc:"Focacce ad alta idratazione — genovese, barese, pugliese e varianti creative."},dolci:{name:"Dolci",dir:"dolci",emoji:"shortcake",unicode:"🍪",title:"Dolci e Pasticceria",desc:"Dolci tradizionali, frolle, biscotti e pasticceria artigianale."},conserve:{name:"Conserve",dir:"conserve",emoji:"canned-food",unicode:"🫙",title:"Conserve e Preparazioni",desc:"Conserve fatte in casa — dadi vegetali, salse, sottoli e preparazioni base."},condimenti:{name:"Condimenti",dir:"condimenti",emoji:"herb",unicode:"🌿",title:"Condimenti",desc:"Salse, pesti e condimenti artigianali per ogni piatto."},secondi_piatti:{name:"Secondi Piatti",dir:"secondi-piatti",emoji:"fork-and-knife",unicode:"🍲",title:"Secondi Piatti",desc:"Esplora ricette complete e saporite per i tuoi secondi piatti: carne, pesce, legumi e verdure."}},we=["primi","pane","pizza","lievitati","dolci","focaccia","conserve","condimenti","secondi_piatti"],$e=Object.fromEntries(Object.values(R).map(e=>[e.dir,e])),xe=Object.fromEntries(Object.values(R).map(e=>[e.name,e.emoji]));Object.values(R).map(e=>e.name);const Ee={"shopping-cart":"shopping-cart","balance-scale":"balance-scale",peanuts:"peanuts",gear:"gear","sheaf-of-rice":"flatbread",fire:"fire","light-bulb":"light-bulb","open-book":"open-book",prohibited:"prohibited",warning:"warning",droplet:"droplet",thermometer:"thermometer",stopwatch:"stopwatch",wrench:"wrench","baguette-bread":"baguette-bread",pizza:"pizza",spaghetti:"spaghetti",croissant:"croissant",cookie:"cookie",flatbread:"flatbread",shortcake:"shortcake","canned-food":"canned-food",herb:"herb","fork-and-knife":"fork-and-knife",star:"star",house:"house","high-voltage":"high-voltage",bullseye:"bullseye",package:"package",tomato:"tomato"};function p(e,t=20,o=""){const i=Ee[e]||e,a=`fluent-emoji${o?" "+o:""}`;return`<img src="${h}images/emoji/${i}.png" width="${t}" height="${t}" alt="" class="${a}" loading="lazy">`}const Y=xe;function Ce(e,t=20){const o=Y[e];return o?p(o,t):""}function x(){be()}const ke=["n/a","na","nessuna","nessuno","none","null","0","-","—"];function $(e){if(e==null)return!1;const t=String(e).trim();return t!==""&&!ke.includes(t.toLowerCase())}async function Le(e,{category:t,slug:o}){e.innerHTML=`
    <div class="recipe-loading">
      <div class="recipe-loading__spinner"></div>
      <p>Caricamento ricetta...</p>
    </div>`;try{const i=`${h}ricette/${t}/${o}.json`,a=await fetch(i);if(!a.ok)throw new Error(`Ricetta non trovata (${a.status})`);const r=await a.json();document.title=`${r.title} — Ricettario Lab`;const n=document.querySelector('meta[name="description"]');n&&n.setAttribute("content",r.description||""),e.innerHTML=Ae(r,t),He(r),_e(r.slug),Fe(),x()}catch(i){e.innerHTML=`
      ...
      </div>`}}function Ae(e,t){const o=Ce(e.category,22),i=e.image?`${h}${e.image.replace(/^\//,"")}`:`${h}images/ricette/${t}/${e.slug}.webp`;return`
    <!-- ═══════════ RECIPE HERO ═══════════ -->
  ...
  `}function H(e){return`<tr${e.excludeFromTotal?' data-exclude-total="true"':""}>
    <td>${m(e.name)} ${e.note?`<span class="ingredient-note">${m(e.note)}</span>`:""}</td>
    <td class="ingredient-qty">${e.grams!=null?`${e.grams}g`:""}</td>
  </tr>`}function Se(e){const t=e.ingredientGroups?.length>0,o=e.ingredients?.length>0;if(!t&&!o)return"";let i;return t?i=e.ingredientGroups.map(a=>{if(!a.items?.length)return"";const r=`<tr class="ingredient-section-header"><td colspan="2">${m(a.group||"Ingredienti")}</td></tr>`,n=a.items.map(H).join("");return r+n}).join(""):i=e.ingredients.map(H).join(""),`
  ...
  `).join("");return`
    ...
    </div>`:""}function Pe(e){if(!e.sensoryProfile||!e.sensoryProfile.axes||e.sensoryProfile.axes.length===0)return"";const t=e.sensoryProfile.axes.reduce((n,s)=>s.value>n.value?s:n,e.sensoryProfile.axes[0]),o=e.sensoryProfile.summary?`
  ...
  `:"";let i="";if(e.nutrition&&e.nutrition.macros){const n=e.nutrition.macros.carbs||0,s=e.nutrition.macros.protein||0,c=e.nutrition.macros.fat||0,g=n+s+c,f=g>0?n/g*100:0,_=g>0?s/g*100:0,l=g>0?c/g*100:0;i=`
  ...
  `}function Re(e){return e.flourTable?.length?`
    ...
    </div>`:""}function He(e){const t=document.getElementById("dose-badge"),o=document.getElementById("dose-decrease"),i=document.getElementById("dose-increase");if(!t||!o||!i)return;const a=.25,r=.25;let n=1;const s=[],c=e.ingredientGroups?.length?e.ingredientGroups.flatMap(d=>d.items||[]):e.ingredients||[],g=["ingredients-table","suspensions-table"],f=[c,e.suspensions||[]];g.forEach((d,y)=>{const w=document.getElementById(d);if(!w)return;const v=w.querySelectorAll("tr:not(.ingredient-section-header)"),k=f[y];let L=0;for(const A of k){if(A.grams==null)continue;if(L>=v.length)break;const S=v[L]?.querySelector(".ingredient-qty");S&&s.push({baseGrams:A.grams,cell:S}),L++}});const _=d=>d===0?"0g":d>=10?`${Math.round(d)}g`:d>=1?`${Math.round(d*10)/10}g`:`${Math.round(d*100)/100}g`,l=d=>{if(Number.isInteger(d))return`×${d}`;const y=Math.round(d*10)/10;return Math.abs(d-y)<.001?`×${y.toFixed(1)}`:`×${d.toFixed(2)}`},b=()=>{t.textContent=l(n),t.classList.toggle("dose-calculator__display--modified",n!==1),o.disabled=n<=r,s.forEach(({baseGrams:d,cell:y})=>{const w=y.getAttribute("data-base"),v=w!==null?parseFloat(w):d;y.textContent=_(v*n),y.getAnimations().forEach(k=>k.cancel()),y.classList.remove("dose-updated"),requestAnimationFrame(()=>y.classList.add("dose-updated"))}),document.querySelectorAll(".dose-inline:not([data-fixed])").forEach(d=>{const y=parseFloat(d.getAttribute("data-base"));isNaN(y)||(d.textContent=J(y*n),d.getAnimations().forEach(w=>w.cancel()),d.classList.remove("dose-updated"),requestAnimationFrame(()=>d.classList.add("dose-updated")))}),qe()};o.addEventListener("click",()=>{const d=Math.round((n-a)*100)/100;d>=r&&(n=d,b())}),i.addEventListener("click",()=>{n=Math.round((n+a)*100)/100,b()}),b()}function qe(){const e=document.getElementById("ingredient-total-qty");if(!e)return;let t=0;const o=document.getElementById("ingredients-table");if(!o)return;o.querySelectorAll("tr:not(.ingredient-section-header):not(.ingredient-total-row):not([data-exclude-total]) .ingredient-qty").forEach(a=>{const r=a.textContent.trim(),n=parseFloat(r);isNaN(n)||(t+=n)});const i=t>=1e3?`~${(t/1e3).toFixed(1)}kg`:`${Math.round(t)}g`;e.textContent=i,e.classList.remove("dose-updated"),e.offsetWidth,e.classList.add("dose-updated")}function m(e){return e?String(e).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;"):""}function Q(e){return e.replace(/\{([a-z_]+):(\d+\.?\d*)(!)?\}/g,(t,o,i,a)=>{const r=parseFloat(i),n=J(r);return`<span class="dose-inline" data-base="${r}" data-token-id="${o}"${a?' data-fixed="true"':""}>${n}</span>`})}function J(e){return e===0?"0":e>=10?`${Math.round(e)}`:e>=1?`${Math.round(e*10)/10}`:`${Math.round(e*100)/100}`}let B=null;function Fe(){const e=document.getElementById("sensory-header");if(!e)return;const t=document.getElementById("sensory-chart-container"),o=e.querySelector(".sensory-chevron");if(!t||!o)return;const i=e.getAttribute("data-chart-id"),a=window.__sensoryChartData?.[i];if(!a)return;let r=null;e.addEventListener("click",async()=>{if(t.style.display==="none"||!t.style.display){if(t.style.display="block",o.style.transform="rotate(180deg)",!B)try{const{Chart:v,RadarController:k,RadialLinearScale:L,PointElement:A,LineElement:S,Filler:ee,Tooltip:te}=await j(async()=>{const{Chart:oe,RadarController:ie,RadialLinearScale:re,PointElement:ae,LineElement:ne,Filler:se,Tooltip:ce}=await import("./chart-Cns13J0s.js");return{Chart:oe,RadarController:ie,RadialLinearScale:re,PointElement:ae,LineElement:ne,Filler:se,Tooltip:ce}},[]);v.register(k,L,A,S,ee,te),B=v}catch(v){console.error("Errore caricamento Chart.js:",v);return}r&&(r.destroy(),r=null);const s=document.getElementById("sensoryChart")?.getContext("2d");if(!s)return;const{labels:c,values:g}=a,f=window.innerWidth<600,_=c.map(v=>f&&v.includes(" ")?v.split(" "):v),l=document.documentElement.getAttribute("data-theme")==="dark",b=l?"rgba(212, 165, 116, 0.8)":"rgba(184, 129, 58, 0.8)",d=l?"rgba(212, 165, 116, 0.2)":"rgba(184, 129, 58, 0.2)",y=l?"rgba(255, 255, 255, 0.1)":"rgba(0, 0, 0, 0.1)",w=l?"#94a3b8":"#64748b";r=new B(s,{type:"radar",data:{labels:_,datasets:[{label:"Valore",data:g,backgroundColor:d,borderColor:b,pointBackgroundColor:b,pointBorderColor:"#fff",pointHoverBackgroundColor:"#fff",pointHoverBorderColor:b,borderWidth:2}]},options:{responsive:!0,maintainAspectRatio:!0,layout:{padding:f?10:20},scales:{r:{min:0,max:10,angleLines:{color:y},grid:{color:y},pointLabels:{color:w,font:{family:"Inter",size:f?10:12,weight:"500"}},ticks:{display:!1,stepSize:2}}},plugins:{legend:{display:!1},tooltip:{backgroundColor:l?"#1e293b":"#fff",titleColor:l?"#f8fafc":"#0f172a",bodyColor:l?"#cbd5e1":"#475569",borderColor:l?"#334155":"#e2e8f0",borderWidth:1,padding:10,displayColors:!1,callbacks:{label:v=>v.formattedValue+" / 10"}}}}})}else t.style.display="none",o.style.transform="rotate(0deg)"})}function Ne(){return`
  ...
  `}function Ve(){if(sessionStorage.getItem("intro-shown"))return;if(window.matchMedia("(prefers-reduced-motion: reduce)").matches){sessionStorage.setItem("intro-shown","1");return}j(()=>Promise.resolve({}),__vite__mapDeps([0]));const e=()=>{document.body.insertAdjacentHTML("afterbegin",Ge()),We(),sessionStorage.setItem("intro-shown","1")};document.body?e():document.addEventListener("DOMContentLoaded",e,{once:!0})}function We(){const e=document.getElementById("logo-intro"),t=document.getElementById("logo-intro-logo");if(!e)return;document.documentElement.style.overflow="hidden";const o=setTimeout(()=>{t&&t.classList.add("glowing")},1700);e.addEventListener("animationend",i=>{i.animationName==="introOverlayOut"&&(document.documentElement.style.overflow="",e.classList.add("logo-intro--done"),requestAnimationFrame(()=>e.remove()),clearTimeout(o))}),setTimeout(()=>{document.getElementById("logo-intro")&&(document.documentElement.style.overflow="",e.remove())},5e3)}const K="?v=861fe2e1";Ve();document.addEventListener("DOMContentLoaded",()=>{Ue(),Xe(),Ye();const e=document.getElementById("current-year");e&&(e.textContent=new Date().getFullYear()),x(),Je(),pe({home:Ze,recipe:Le,category:tt,cottura:async(t,o)=>{const{renderCottura:i}=await j(async()=>{const{renderCottura:a}=await import("./pagina-CpfCwZLO.js");return{renderCottura:a}},__vite__mapDeps([1,2]));return i(t,o)}}),ge()});function Ue(){const e=document.getElementById("navbar");if(!e)return;const t=()=>e.classList.toggle("scrolled",window.scrollY>50);window.addEventListener("scroll",t,{passive:!0}),t()}function Xe(){const e=document.getElementById("theme-toggle");e&&(e.addEventListener("click",()=>{const o=document.documentElement.getAttribute("data-theme")==="dark"?"light":"dark";e.classList.add("theme-toggle--switching"),setTimeout(()=>e.classList.remove("theme-toggle--switching"),400),document.documentElement.setAttribute("data-theme",o),localStorage.setItem("theme",o)}),window.matchMedia("(prefers-color-scheme: dark)").addEventListener("change",t=>{localStorage.getItem("theme")||document.documentElement.setAttribute("data-theme",t.matches?"dark":"light")}))}function Ye(){const e=document.getElementById("hamburger"),t=document.getElementById("nav-links");!e||!t||(e.addEventListener("click",()=>{e.classList.toggle("open"),t.classList.toggle("open")}),t.querySelectorAll("a").forEach(o=>{o.addEventListener("click",()=>{e.classList.remove("open"),t.classList.remove("open")})}),document.addEventListener("click",o=>{!e.contains(o.target)&&!t.contains(o.target)&&(e.classList.remove("open"),t.classList.remove("open"))}))}let E=null;function Qe(e){const t=new URL(h,window.location.origin),o=i=>!i||/^([a-z]+:|\/\/|\/|#)/i.test(i)?i:new URL(i,t).pathname;e.querySelectorAll("[src], [href], [srcset]").forEach(i=>{["src","href"].forEach(r=>{const n=i.getAttribute(r);n&&i.setAttribute(r,o(n))});const a=i.getAttribute("srcset");a&&i.setAttribute("srcset",a.split(",").map(r=>{const[n,...s]=r.trim().split(/\s+/);return[o(n),...s].join(" ")}).join(", "))})}function Z(e,t,o){const i=e.cloneNode(!0);return Qe(i),{html:i.innerHTML,title:t,description:o}}function Je(){const e=document.getElementById("app");e?.querySelector("#ricette")&&(E=Z(e,document.title,document.querySelector('meta[name="description"]')?.getAttribute("content")||""))}async function Ke(){if(E)return E;const e=await fetch(h),t=new DOMParser().parseFromString(await e.text(),"text/html"),o=t.getElementById("app");if(!o)throw new Error("index.html non contiene #app");return E=Z(o,t.title,t.querySelector('meta[name="description"]')?.getAttribute("content")||""),E}async function Ze(e){if(!e.querySelector("#ricette"))try{const o=await Ke();e.innerHTML=o.html}catch(o){console.error("Impossibile ricostruire la homepage:",o),window.location.assign(h);return}const t=E;if(t){document.title=t.title;const o=document.querySelector('meta[name="description"]');o&&o.setAttribute("content",t.description)}x(),rt(),P()}const C=12,et=$e;let u={allRecipes:[],filteredRecipes:[],displayedCount:C,viewMode:"grid",sortType:"az",searchQuery:"",categoryDir:""};async function tt(e,{category:t}){const o=et[t];if(!o){document.title="Categoria non trovata — Ricettario Lab",e.innerHTML=`
      <div class="container" style="padding: 120px 0; text-align: center;">
      ...
      </div>`,x();return}document.title=`${o.title} — Il Ricettario`;const i=document.querySelector('meta[name="description"]');i&&i.setAttribute("content",o.desc),u={allRecipes:[],filteredRecipes:[],displayedCount:C,viewMode:localStorage.getItem("catViewMode")||"grid",sortType:"az",searchQuery:"",categoryDir:t},e.innerHTML=`
  ...
  `,x();try{const r=await(await fetch(`${h}recipes.json${K}`)).json();u.allRecipes=r.recipes.filter(c=>c.categoryDir===t||c.category===o.name),u.allRecipes.sort((c,g)=>(c.title||"").localeCompare(g.title||"","it")),u.filteredRecipes=[...u.allRecipes];const n=u.allRecipes.find(c=>c.image);if(n){const c=document.getElementById("category-hero");c&&(c.style.backgroundImage=`url('${h}${n.image}')`)}const s=document.getElementById("recipe-count");s&&(s.innerHTML=`${p("bullseye",16)} ${u.allRecipes.length} ricett${u.allRecipes.length===1?"a":"e"}`),T(),ot(e),P(),I()}catch(a){console.error("Errore caricamento categoria:",a);const r=document.getElementById("category-grid");r&&(r.innerHTML=`<div class="category-empty"><div class="category-empty__icon">${p("prohibited",32)}</div><p>Errore nel caricamento delle ricette.</p></div>`)}}function ot(e){const t=document.getElementById("category-search");let o;t&&t.addEventListener("input",()=>{clearTimeout(o),o=setTimeout(()=>{u.searchQuery=t.value.toLowerCase().trim(),u.displayedCount=C,q(),T()},150)});const i=e.querySelectorAll(".category-toolbar__sort-btn");i.forEach(r=>{r.addEventListener("click",()=>{i.forEach(n=>n.classList.remove("active")),r.classList.add("active"),u.sortType=r.dataset.sort,u.displayedCount=C,q(),T()})});const a=e.querySelectorAll(".view-toggle-btn");a.forEach(r=>{r.addEventListener("click",()=>{a.forEach(s=>s.classList.remove("active")),r.classList.add("active"),u.viewMode=r.dataset.view,localStorage.setItem("catViewMode",u.viewMode);const n=document.getElementById("category-grid");n&&n.classList.toggle("category-grid--list",u.viewMode==="list")})})}function q(){let e=[...u.allRecipes];u.searchQuery&&(e=e.filter(t=>{const o=(t.title||"").toLowerCase(),i=(t.description||"").toLowerCase();return o.includes(u.searchQuery)||i.includes(u.searchQuery)})),u.sortType==="az"?e.sort((t,o)=>(t.title||"").localeCompare(o.title||"","it")):u.sortType==="hydration"&&e.sort((t,o)=>(parseInt(o.hydration)||0)-(parseInt(t.hydration)||0)),u.filteredRecipes=e}function T(){const e=document.getElementById("category-grid"),t=document.getElementById("load-more-container");if(!e)return;const{filteredRecipes:o,displayedCount:i,categoryDir:a}=u,r=o.slice(0,i),n=o.length,s=document.getElementById("results-counter");if(s&&(u.searchQuery?s.innerHTML=`<strong>${n}</strong> risultat${n===1?"o":"i"}`:s.innerHTML=`<strong>${Math.min(i,n)}</strong> di <strong>${n}</strong>`),n===0){e.innerHTML=`
      ...
      </div>`,t&&(t.innerHTML=""),x();return}if(e.innerHTML=r.map((c,g)=>`
      <a href="${`${h}ricette/${c.categoryDir||a}/${c.slug}`}" class="category-card" data-link
         data-title="${(c.title||"").toLowerCase()}"
         data-hydration="${parseInt(c.hydration)||0}">
        <div class="category-card__image-wrapper">
          ${c.image?W(`${h}${c.image}`,c.title,"category-card__image","lazy"):""}
      ...
      </a>`).join(""),t)if(i<n){const c=n-i,g=Math.round(i/n*100);t.innerHTML=`
        ...
        </div>`,document.getElementById("load-more-btn")?.addEventListener("click",()=>{u.displayedCount+=C,T(),setTimeout(()=>{const _=e.querySelectorAll(".category-card")[i];_&&_.scrollIntoView({behavior:"smooth",block:"center"})},100),I()})}else t.innerHTML="";x(),I()}function it(e){return Array.from({length:e},()=>`
    ...
    </div>`).join("")}function F(e,t,o,i,a){const r=document.createElement("div");r.className="category-row reveal",r.dataset.category=t,r.innerHTML=`
  ...
  `,e.appendChild(r);const n=r.querySelector(".category-row__carousel"),s=r.querySelector(".category-row__carousel-wrapper"),c=r.querySelector(".carousel-arrow--prev"),g=r.querySelector(".carousel-arrow--next"),f=276,_=()=>{const{scrollLeft:l,scrollWidth:b,clientWidth:d}=n;s.classList.toggle("has-scroll-left",l>10),s.classList.toggle("has-scroll-right",l<b-d-10),c.disabled=l<=10,g.disabled=l>=b-d-10};n.addEventListener("scroll",_,{passive:!0}),requestAnimationFrame(_),c.addEventListener("click",()=>n.scrollBy({left:-f*3,behavior:"smooth"})),g.addEventListener("click",()=>n.scrollBy({left:f*3,behavior:"smooth"}))}function rt(){const e=document.getElementById("recipe-carousels");if(!e)return;const t=we.map(o=>{const i=R[o];return{key:i.name,emoji:i.emoji,dir:i.dir}});fetch(`${h}recipes.json${K}`).then(o=>o.json()).then(o=>{e.innerHTML="";const i={};o.recipes.forEach(r=>{i[r.category]||(i[r.category]=[]),i[r.category].push(r)}),t.forEach(r=>{const n=i[r.key];!n||n.length===0||F(e,r.key,r.emoji,r.dir,n)});const a=new Set(t.map(r=>r.key));Object.keys(i).forEach(r=>{if(a.has(r))return;const n=i[r];if(!n||n.length===0)return;const s=r.toLowerCase(),c=Y[r]||"fork-and-knife";F(e,r,c,s,n)}),P(),at(),I()}).catch(o=>{console.error("Errore caricamento recipes.json:",o),e.innerHTML='<p style="text-align:center; color: var(--color-text-muted);">Errore nel caricamento delle ricette.</p>'})}function at(){const e=document.getElementById("search-input");e&&(e.addEventListener("input",()=>{const t=e.value.toLowerCase().trim(),o=document.querySelectorAll(".recipe-card--compact"),i=document.querySelectorAll(".category-row");o.forEach(a=>{const r=a.dataset.title||a.textContent.toLowerCase();a.classList.toggle("hidden",!!(t&&!r.includes(t)))}),i.forEach(a=>{const r=a.querySelectorAll(".recipe-card--compact:not(.hidden)");a.classList.toggle("hidden",r.length===0)})}),document.addEventListener("keydown",t=>{t.key==="/"&&document.activeElement!==e&&(t.preventDefault(),e.focus(),e.scrollIntoView({behavior:"smooth",block:"center"})),t.key==="Escape"&&document.activeElement===e&&(e.value="",e.dispatchEvent(new Event("input")),e.blur())}))}export{h as B,M as n};
