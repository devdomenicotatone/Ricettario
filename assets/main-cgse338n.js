const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/logo-intro-Cp8JEbss.css","assets/pagina-CZLXw_1y.js","assets/pagina-CWlLvqi1.css"])))=>i.map(i=>d[i]);
(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const a of document.querySelectorAll('link[rel="modulepreload"]'))i(a);new MutationObserver(a=>{for(const r of a)if(r.type==="childList")for(const n of r.addedNodes)n.tagName==="LINK"&&n.rel==="modulepreload"&&i(n)}).observe(document,{childList:!0,subtree:!0});function o(a){const r={};return a.integrity&&(r.integrity=a.integrity),a.referrerPolicy&&(r.referrerPolicy=a.referrerPolicy),a.crossOrigin==="use-credentials"?r.credentials="include":a.crossOrigin==="anonymous"?r.credentials="omit":r.credentials="same-origin",r}function i(a){if(a.ep)return;a.ep=!0;const r=o(a);fetch(a.href,r)}})();const pe="modulepreload",ue=function(e){return"/Ricettario/"+e},O={},D=function(t,o,i){let a=Promise.resolve();if(o&&o.length>0){let n=function(u){return Promise.all(u.map(f=>Promise.resolve(f).then(_=>({status:"fulfilled",value:_}),_=>({status:"rejected",reason:_}))))};document.getElementsByTagName("link");const s=document.querySelector("meta[property=csp-nonce]"),c=s?.nonce||s?.getAttribute("nonce");a=n(o.map(u=>{if(u=ue(u),u in O)return;O[u]=!0;const f=u.endsWith(".css"),_=f?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${u}"]${_}`))return;const l=document.createElement("link");if(l.rel=f?"stylesheet":pe,f||(l.as="script"),l.crossOrigin="",l.href=u,c&&l.setAttribute("nonce",c),document.head.appendChild(l),f)return new Promise((v,d)=>{l.addEventListener("load",v),l.addEventListener("error",()=>d(new Error(`Unable to preload CSS for ${u}`)))})}))}function r(n){const s=new Event("vite:preloadError",{cancelable:!0});if(s.payload=n,window.dispatchEvent(s),!s.defaultPrevented)throw n}return a.then(n=>{for(const s of n||[])s.status==="rejected"&&r(s.reason);return t().catch(r)})},m="/Ricettario/";let V={};function ge(e){V=e}function U(e){let t=e.replace(m,"").replace(/^\/+|\/+$/g,"");if(!t||t==="index.html")return{type:"home",params:{}};const o=t.match(/^ricette\/([^/]+)\/([^/]+?)(?:\.html)?$/);if(o)return{type:"recipe",params:{category:o[1],slug:o[2]}};const i=t.match(/^ricette\/([^/]+)\/?$/);if(i)return{type:"category",params:{category:i[1]}};const a=t.match(/^cottura(?:\/([^/]+?))?(?:\.html)?$/);return a?{type:"cottura",params:{config:a[1]||null}}:{type:"home",params:{}}}async function M(e,t=!0){const o=new URL(e,window.location.origin);t&&history.pushState(null,"",o.pathname+o.search);const i=U(o.pathname),a=document.getElementById("app");a&&(window.scrollTo(0,0),"startViewTransition"in document?document.startViewTransition(async()=>{await F(i,a)}):await F(i,a))}async function F(e,t){const o=V[e.type];o?await o(t,e.params):t.innerHTML=`<div class="container" style="padding: 80px 0; text-align: center;">
      <h2>Pagina non trovata</h2>
      <p><a href="${m}" data-link>← Torna alla Home</a></p>
    </div>`,R()}function R(){const e=document.querySelectorAll(".reveal:not(.visible)");if(e.length===0)return;const t=new IntersectionObserver(o=>{o.forEach(i=>{i.isIntersecting&&(i.target.classList.add("visible"),t.unobserve(i.target))})},{threshold:.1,rootMargin:"0px 0px -50px 0px"});e.forEach(o=>t.observe(o))}function me(){const e=sessionStorage.getItem("spa-redirect");e&&(sessionStorage.removeItem("spa-redirect"),history.replaceState(null,"",e)),document.addEventListener("click",t=>{const o=t.target.closest("a[href]");if(!o)return;const i=o.getAttribute("href"),a=o.getAttribute("data-nav-section");if(a){if(U(window.location.pathname).type!=="home"){t.preventDefault(),M(m).then(()=>{setTimeout(()=>{const s=document.getElementById(a);s&&s.scrollIntoView({behavior:"smooth"})},100)});return}return}if(!i||i.startsWith("http")||i.startsWith("#")||i.startsWith("mailto:")||i.startsWith("tel:")||o.target==="_blank")return;t.preventDefault();const r=new URL(i,window.location.href);M(r.href)}),window.addEventListener("popstate",()=>{M(window.location.href,!1)}),M(window.location.href,!1)}function W(e){const t=e.replace(/\.(jpg|jpeg|png|webp)$/i,"");return{avif:`${t}.avif`,webp:`${t}.webp`}}function X(e,t,o="",i="lazy"){if(!e)return"";const{avif:a,webp:r}=W(e),n=o?` class="${o}"`:"",s=i?` loading="${i}"`:"";return`<picture>
  <source srcset="${a}" type="image/avif">
  <source srcset="${r}" type="image/webp">
  <img src="${r}" alt="${t}"${n}${s}>
</picture>`}function he(e,t){if(!e)return"";const{avif:o,webp:i}=W(e);return`<picture class="recipe-hero__picture">
  <source srcset="${o}" type="image/avif">
  <source srcset="${i}" type="image/webp">
  <img src="${i}" alt="${t}" class="recipe-hero__img">
</picture>`}const Y="ricettario_fatte";function j(){try{const e=localStorage.getItem(Y);return e?new Set(JSON.parse(e)):new Set}catch{return new Set}}function fe(e){localStorage.setItem(Y,JSON.stringify([...e]))}function _e(e){return j().has(e)}function ye(e){const t=j(),o=!t.has(e);return o?t.add(e):t.delete(e),fe(t),o}function T(){const e=j();if(e.size===0)return;document.querySelectorAll(".recipe-card--compact, .category-card").forEach(o=>{const i=o.getAttribute("href")||"",a=new URL(i,location.origin).pathname.split("/").filter(Boolean).pop();if(a&&e.has(a)&&!o.querySelector(".made-badge")){const r=document.createElement("span");r.className="made-badge",r.textContent="✓",r.title="Ricetta già fatta!";const n=o.querySelector(".recipe-card--compact__image-wrapper, .category-card__image-wrapper");n&&n.appendChild(r)}})}function be(e){const t=document.getElementById("made-toggle");if(!t)return;const o=i=>{t.classList.toggle("made-toggle--active",i),t.innerHTML=i?'<span class="made-toggle__icon">✓</span> <span class="made-toggle__label">Fatta!</span>':'<span class="made-toggle__icon">○</span> <span class="made-toggle__label">Segna come fatta</span>',t.title=i?"Clicca per rimuovere":"Segna questa ricetta come fatta"};o(_e(e)),t.addEventListener("click",i=>{i.preventDefault();const a=ye(e);o(a),t.classList.add("made-toggle--pop"),setTimeout(()=>t.classList.remove("made-toggle--pop"),400)})}const ve={"arrow-up-right":'<path d="M7 7h10v10"/><path d="M7 17 17 7"/>',"chevron-down":'<path d="m6 9 6 6 6-6"/>',"grid-3x3":'<rect width="18" height="18" x="3" y="3" rx="2"/><path d="M3 9h18"/><path d="M3 15h18"/><path d="M9 3v18"/><path d="M15 3v18"/>',list:'<path d="M3 5h.01"/><path d="M3 12h.01"/><path d="M3 19h.01"/><path d="M8 5h13"/><path d="M8 12h13"/><path d="M8 19h13"/>',microscope:'<path d="M6 18h8"/><path d="M3 22h18"/><path d="M14 22a7 7 0 1 0 0-14h-1"/><path d="M9 14h2"/><path d="M9 12a2 2 0 0 1-2-2V6h6v4a2 2 0 0 1-2 2Z"/><path d="M12 6V3a1 1 0 0 0-1-1H9a1 1 0 0 0-1 1v3"/>',moon:'<path d="M20.985 12.486a9 9 0 1 1-9.473-9.472c.405-.022.617.46.402.803a6 6 0 0 0 8.268 8.268c.344-.215.825-.004.803.401"/>',search:'<path d="m21 21-4.34-4.34"/><circle cx="11" cy="11" r="8"/>',sun:'<circle cx="12" cy="12" r="4"/><path d="M12 2v2"/><path d="M12 20v2"/><path d="m4.93 4.93 1.41 1.41"/><path d="m17.66 17.66 1.41 1.41"/><path d="M2 12h2"/><path d="M20 12h2"/><path d="m6.34 17.66-1.41 1.41"/><path d="m19.07 4.93-1.41 1.41"/>'},Q="http://www.w3.org/2000/svg",we={xmlns:Q,width:"24",height:"24",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor","stroke-width":"2","stroke-linecap":"round","stroke-linejoin":"round"};function $e(e=document){for(const t of e.querySelectorAll("[data-lucide]")){const o=t.getAttribute("data-lucide"),i=ve[o];if(!i){console.warn(`[icons] icona "${o}" non disponibile: aggiungila a js/icons.js`);continue}const a=document.createElementNS(Q,"svg");for(const[r,n]of Object.entries(we))a.setAttribute(r,n);for(const r of t.attributes)r.name!=="data-lucide"&&a.setAttribute(r.name,r.value);a.setAttribute("class",`lucide lucide-${o}${t.className?" "+t.className:""}`),a.innerHTML=i,t.replaceWith(a)}}const B={pane:{name:"Pane",dir:"pane",emoji:"baguette-bread",unicode:"🥖",title:"Pane Artigianale",desc:"Ricette di pane ad alta idratazione — ciabatta, filone, baguette e pane speciale."},pizza:{name:"Pizza",dir:"pizza",emoji:"pizza",unicode:"🍕",title:"Pizza Artigianale",desc:"Pizze con lievitazione lunga — napoletana, in teglia, canotto e pinsa romana."},primi:{name:"Primi",dir:"primi",emoji:"tomato",unicode:"🥣",title:"Primi Piatti",desc:"Primi piatti della tradizione — gnocchi, polenta, zuppe e piatti unici caldi."},lievitati:{name:"Lievitati",dir:"lievitati",emoji:"croissant",unicode:"🥐",title:"Lievitati Dolci e Salati",desc:"Brioche, cornetti, panettone, burger buns e rosticceria."},focaccia:{name:"Focaccia",dir:"focaccia",emoji:"flatbread",unicode:"🫓",title:"Focaccia Artigianale",desc:"Focacce ad alta idratazione — genovese, barese, pugliese e varianti creative."},dolci:{name:"Dolci",dir:"dolci",emoji:"shortcake",unicode:"🍪",title:"Dolci e Pasticceria",desc:"Dolci tradizionali, frolle, biscotti e pasticceria artigianale."},conserve:{name:"Conserve",dir:"conserve",emoji:"canned-food",unicode:"🫙",title:"Conserve e Preparazioni",desc:"Conserve fatte in casa — dadi vegetali, salse, sottoli e preparazioni base."},condimenti:{name:"Condimenti",dir:"condimenti",emoji:"herb",unicode:"🌿",title:"Condimenti",desc:"Salse, pesti e condimenti artigianali per ogni piatto."},secondi_piatti:{name:"Secondi Piatti",dir:"secondi-piatti",emoji:"fork-and-knife",unicode:"🍲",title:"Secondi Piatti",desc:"Esplora ricette complete e saporite per i tuoi secondi piatti: carne, pesce, legumi e verdure."}},xe=["primi","pane","pizza","lievitati","dolci","focaccia","conserve","condimenti","secondi_piatti"],Ee=Object.fromEntries(Object.values(B).map(e=>[e.dir,e])),Ce=Object.fromEntries(Object.values(B).map(e=>[e.name,e.emoji]));Object.values(B).map(e=>e.name);const ke={"shopping-cart":"shopping-cart","balance-scale":"balance-scale",peanuts:"peanuts",gear:"gear","sheaf-of-rice":"flatbread",fire:"fire","light-bulb":"light-bulb","open-book":"open-book",prohibited:"prohibited",warning:"warning",droplet:"droplet",thermometer:"thermometer",stopwatch:"stopwatch",wrench:"wrench","baguette-bread":"baguette-bread",pizza:"pizza",spaghetti:"spaghetti",croissant:"croissant",cookie:"cookie",flatbread:"flatbread",shortcake:"shortcake","canned-food":"canned-food",herb:"herb","fork-and-knife":"fork-and-knife",star:"star",house:"house","high-voltage":"high-voltage",bullseye:"bullseye",package:"package",tomato:"tomato"};function p(e,t=20,o=""){const i=ke[e]||e,a=`fluent-emoji${o?" "+o:""}`;return`<img src="${m}images/emoji/${i}.png" width="${t}" height="${t}" alt="" class="${a}" loading="lazy">`}const J=Ce;function Le(e,t=20){const o=J[e];return o?p(o,t):""}function x(){$e()}const Se=["n/a","na","nessuna","nessuno","none","null","0","-","—"];function $(e){if(e==null)return!1;const t=String(e).trim();return t!==""&&!Se.includes(t.toLowerCase())}const Ae=["immagine esistente","caricata manualmente"],Me=["pexels","unsplash","pixabay","wikimedia","openverse","flickr"],H={"pexels license":"https://www.pexels.com/license/","unsplash license":"https://unsplash.com/license","pixabay license":"https://pixabay.com/service/license-summary/"};function I(e){return String(e??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;")}function Ie(e){const t=String(e??"").trim().toLowerCase();if(!t)return null;if(H[t])return H[t];const o=t.replace(/^cc\s+/,"");if(/^cc0\b/.test(o)||o==="zero")return"https://creativecommons.org/publicdomain/zero/1.0/";if(/^(public domain|pdm|dominio pubblico)\b/.test(o))return"https://creativecommons.org/publicdomain/mark/1.0/";const i=o.match(/^(by(?:-nc)?(?:-sa|-nd)?)\s+(\d\.\d)$/);return i?`https://creativecommons.org/licenses/${i[1]}/${i[2]}/`:null}function Te(e){const t=String(e??"").trim();if(!/^https:\/\//i.test(t))return null;const o=t.match(/^https:\/\/upload\.wikimedia\.org\/wikipedia\/[a-z-]+\/(?:thumb\/)?[0-9a-f]\/[0-9a-f]{2}\/([^/?#]+)/i);if(o)return`https://commons.wikimedia.org/wiki/File:${o[1]}`;const i=t.match(/^https:\/\/images\.pexels\.com\/photos\/(\d+)\//i);return i?`https://www.pexels.com/photo/${i[1]}/`:/^https:\/\/(commons\.wikimedia\.org\/wiki\/|www\.pexels\.com\/photo\/|unsplash\.com\/photos\/|pixabay\.com\/[a-z-]+\/|openverse\.org\/image\/|www\.flickr\.com\/photos\/)/i.test(t)?t:null}function Pe(e,t){const o=String(e??"").trim();if(!o)return null;const i=o.replace(/^📷\s*/,"").replace(/^Foto:\s*/i,"").trim();if(!i||Ae.includes(i.toLowerCase()))return null;const a=i.split(/\s+[—–]\s+/),r=a[0].trim();if(!r)return null;let n=null,s=null;if(a.length>1){const c=a.slice(1).join(" — ").trim(),u=c.match(/^(.*?)\s+via\s+(.+)$/i);u?(n=u[1].trim()||null,s=u[2].trim()):Me.includes(c.toLowerCase())?s=c:n=c||null}return{autore:r,licenza:n,fonte:s,urlLicenza:Ie(n),urlFonte:Te(t)}}function Re(e,t){const o=Pe(e,t);if(!o)return"";const i=(n,s,c)=>s?`<a href="${I(s)}" target="_blank" rel="${c}">${I(n)}</a>`:I(n),a=!!(o.licenza&&!o.urlLicenza&&o.urlFonte);let r=`Foto: ${I(o.autore)}`;return o.licenza&&(r+=a?` — ${i(o.licenza,o.urlFonte,"noopener nofollow")}`:` — ${i(o.licenza,o.urlLicenza,"license noopener nofollow")}`),o.fonte?r+=` via ${i(o.fonte,a?null:o.urlFonte,"noopener nofollow")}`:o.urlFonte&&!a&&(r+=` — ${i("fonte",o.urlFonte,"noopener nofollow")}`),r}async function Be(e,{category:t,slug:o}){e.innerHTML=`
    <div class="recipe-loading">
      <div class="recipe-loading__spinner"></div>
      <p>Caricamento ricetta...</p>
    </div>`;try{const i=`${m}ricette/${t}/${o}.json`,a=await fetch(i);if(!a.ok)throw new Error(`Ricetta non trovata (${a.status})`);const r=await a.json();document.title=`${r.title} — Ricettario Lab`;const n=document.querySelector('meta[name="description"]');n&&n.setAttribute("content",r.description||""),e.innerHTML=ze(r,t),Xe(r),be(r.slug),Qe(),x()}catch(i){e.innerHTML=`
      ...
      </div>`}}function ze(e,t){const o=Le(e.category,22),i=e.image?`${m}${e.image.replace(/^\//,"")}`:`${m}images/ricette/${t}/${e.slug}.webp`,a=Re(e.imageAttribution,e._originalImageUrl);return`
    <!-- ═══════════ RECIPE HERO ═══════════ -->
  ...
  `}function q(e){return`<tr${e.excludeFromTotal?' data-exclude-total="true"':""}>
    <td>${h(e.name)} ${e.note?`<span class="ingredient-note">${h(e.note)}</span>`:""}</td>
    <td class="ingredient-qty">${e.grams!=null?`${e.grams}g`:""}</td>
  </tr>`}function De(e){const t=e.ingredientGroups?.length>0,o=e.ingredients?.length>0;if(!t&&!o)return"";let i;return t?i=e.ingredientGroups.map(a=>{if(!a.items?.length)return"";const r=`<tr class="ingredient-section-header"><td colspan="2">${h(a.group||"Ingredienti")}</td></tr>`,n=a.items.map(q).join("");return r+n}).join(""):i=e.ingredients.map(q).join(""),`
    ...
    </div>`}function je(e){const t=e.suspensions.map(o=>`
    <tr>
  ...
  `).join("");return`
    ...
    </div>`}function Oe(e){const t=e.steps;return t?.length?`
    ...
    </div>`:""}function Fe(e){const t=e.stepsCondiment;return t?.length?`
    ...
    </div>`:""}function He(e){if(!e.sensoryProfile||!e.sensoryProfile.axes||e.sensoryProfile.axes.length===0)return"";const t=e.sensoryProfile.axes.reduce((n,s)=>s.value>n.value?s:n,e.sensoryProfile.axes[0]),o=e.sensoryProfile.summary?`
  ...
  `:"";let i="";if(e.nutrition&&e.nutrition.macros){const n=e.nutrition.macros.carbs||0,s=e.nutrition.macros.protein||0,c=e.nutrition.macros.fat||0,u=n+s+c,f=u>0?n/u*100:0,_=u>0?s/u*100:0,l=u>0?c/u*100:0;i=`
      ...
      `}const a={labels:e.sensoryProfile.axes.map(n=>n.label),values:e.sensoryProfile.axes.map(n=>n.value)},r=`sensory_${Date.now()}`;return window.__sensoryChartData=window.__sensoryChartData||{},window.__sensoryChartData[r]=a,`
  ...
  `}function qe(e){return e.flourTable?.length?`
    ...
    </div>`:""}function Ne(e){return e.alert?`
    ...
    </div>`:""}function Ge(e){if(!e.baking)return"";const t=e.baking;return`
    <div class="recipe-panel reveal recipe-panel--spaced">
      <h2 class="recipe-panel__title">
    ...
    </div>`}function Ve(e){return e.proTips?.length?`
    <div class="recipe-panel reveal recipe-panel--spaced">
      <h2 class="recipe-panel__title">
    ...
    </div>`:""}function Ue(e){return e.storage?.length?`
    <div class="recipe-panel reveal recipe-panel--spaced">
      <h2 class="recipe-panel__title">
    ...
    </div>`:""}function We(e){return e.glossary?.length?`
    <div class="recipe-panel reveal recipe-panel--spaced">
      <h2 class="recipe-panel__title">
    ...
    </div>`:""}function Xe(e){const t=document.getElementById("dose-badge"),o=document.getElementById("dose-decrease"),i=document.getElementById("dose-increase");if(!t||!o||!i)return;const a=.25,r=.25;let n=1;const s=[],c=e.ingredientGroups?.length?e.ingredientGroups.flatMap(d=>d.items||[]):e.ingredients||[],u=["ingredients-table","suspensions-table"],f=[c,e.suspensions||[]];u.forEach((d,y)=>{const w=document.getElementById(d);if(!w)return;const b=w.querySelectorAll("tr:not(.ingredient-section-header)"),k=f[y];let L=0;for(const S of k){if(S.grams==null)continue;if(L>=b.length)break;const A=b[L]?.querySelector(".ingredient-qty");A&&s.push({baseGrams:S.grams,cell:A}),L++}});const _=d=>d===0?"0g":d>=10?`${Math.round(d)}g`:d>=1?`${Math.round(d*10)/10}g`:`${Math.round(d*100)/100}g`,l=d=>{if(Number.isInteger(d))return`×${d}`;const y=Math.round(d*10)/10;return Math.abs(d-y)<.001?`×${y.toFixed(1)}`:`×${d.toFixed(2)}`},v=()=>{t.textContent=l(n),t.classList.toggle("dose-calculator__display--modified",n!==1),o.disabled=n<=r,s.forEach(({baseGrams:d,cell:y})=>{const w=y.getAttribute("data-base"),b=w!==null?parseFloat(w):d;y.textContent=_(b*n),y.getAnimations().forEach(k=>k.cancel()),y.classList.remove("dose-updated"),requestAnimationFrame(()=>y.classList.add("dose-updated"))}),document.querySelectorAll(".dose-inline:not([data-fixed])").forEach(d=>{const y=parseFloat(d.getAttribute("data-base"));isNaN(y)||(d.textContent=K(y*n),d.getAnimations().forEach(w=>w.cancel()),d.classList.remove("dose-updated"),requestAnimationFrame(()=>d.classList.add("dose-updated")))}),Ye()};o.addEventListener("click",()=>{const d=Math.round((n-a)*100)/100;d>=r&&(n=d,v())}),i.addEventListener("click",()=>{n=Math.round((n+a)*100)/100,v()}),v()}function Ye(){const e=document.getElementById("ingredient-total-qty");if(!e)return;let t=0;const o=document.getElementById("ingredients-table");if(!o)return;o.querySelectorAll("tr:not(.ingredient-section-header):not(.ingredient-total-row):not([data-exclude-total]) .ingredient-qty").forEach(a=>{const r=a.textContent.trim(),n=parseFloat(r);isNaN(n)||(t+=n)});const i=t>=1e3?`~${(t/1e3).toFixed(1)}kg`:`${Math.round(t)}g`;e.textContent=i,e.classList.remove("dose-updated"),e.offsetWidth,e.classList.add("dose-updated")}function h(e){return e?String(e).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;"):""}function Z(e){return e.replace(/\{([a-z_]+):(\d+\.?\d*)(!)?\}/g,(t,o,i,a)=>{const r=parseFloat(i),n=K(r);return`<span class="dose-inline" data-base="${r}" data-token-id="${o}"${a?' data-fixed="true"':""}>${n}</span>`})}function K(e){return e===0?"0":e>=10?`${Math.round(e)}`:e>=1?`${Math.round(e*10)/10}`:`${Math.round(e*100)/100}`}let z=null;function Qe(){const e=document.getElementById("sensory-header");if(!e)return;const t=document.getElementById("sensory-chart-container"),o=e.querySelector(".sensory-chevron");if(!t||!o)return;const i=e.getAttribute("data-chart-id"),a=window.__sensoryChartData?.[i];if(!a)return;let r=null;e.addEventListener("click",async()=>{if(t.style.display==="none"||!t.style.display){if(t.style.display="block",o.style.transform="rotate(180deg)",!z)try{const{Chart:b,RadarController:k,RadialLinearScale:L,PointElement:S,LineElement:A,Filler:oe,Tooltip:ie}=await D(async()=>{const{Chart:re,RadarController:ae,RadialLinearScale:ne,PointElement:se,LineElement:ce,Filler:le,Tooltip:de}=await import("./chart-Cns13J0s.js");return{Chart:re,RadarController:ae,RadialLinearScale:ne,PointElement:se,LineElement:ce,Filler:le,Tooltip:de}},[]);b.register(k,L,S,A,oe,ie),z=b}catch(b){console.error("Errore caricamento Chart.js:",b);return}r&&(r.destroy(),r=null);const s=document.getElementById("sensoryChart")?.getContext("2d");if(!s)return;const{labels:c,values:u}=a,f=window.innerWidth<600,_=c.map(b=>f&&b.includes(" ")?b.split(" "):b),l=document.documentElement.getAttribute("data-theme")==="dark",v=l?"rgba(212, 165, 116, 0.8)":"rgba(184, 129, 58, 0.8)",d=l?"rgba(212, 165, 116, 0.2)":"rgba(184, 129, 58, 0.2)",y=l?"rgba(255, 255, 255, 0.1)":"rgba(0, 0, 0, 0.1)",w=l?"#94a3b8":"#64748b";r=new z(s,{type:"radar",data:{labels:_,datasets:[{label:"Valore",data:u,backgroundColor:d,borderColor:v,pointBackgroundColor:v,pointBorderColor:"#fff",pointHoverBackgroundColor:"#fff",pointHoverBorderColor:v,borderWidth:2}]},options:{responsive:!0,maintainAspectRatio:!0,layout:{padding:f?10:20},scales:{r:{min:0,max:10,angleLines:{color:y},grid:{color:y},pointLabels:{color:w,font:{family:"Inter",size:f?10:12,weight:"500"}},ticks:{display:!1,stepSize:2}}},plugins:{legend:{display:!1},tooltip:{backgroundColor:l?"#1e293b":"#fff",titleColor:l?"#f8fafc":"#0f172a",bodyColor:l?"#cbd5e1":"#475569",borderColor:l?"#334155":"#e2e8f0",borderWidth:1,padding:10,displayColors:!1,callbacks:{label:b=>b.formattedValue+" / 10"}}}}})}else t.style.display="none",o.style.transform="rotate(0deg)"})}function Je(){return`
  ...
  `}function Ke(){if(sessionStorage.getItem("intro-shown"))return;if(window.matchMedia("(prefers-reduced-motion: reduce)").matches){sessionStorage.setItem("intro-shown","1");return}D(()=>Promise.resolve({}),__vite__mapDeps([0]));const e=()=>{document.body.insertAdjacentHTML("afterbegin",Ze()),et(),sessionStorage.setItem("intro-shown","1")};document.body?e():document.addEventListener("DOMContentLoaded",e,{once:!0})}function et(){const e=document.getElementById("logo-intro"),t=document.getElementById("logo-intro-logo");if(!e)return;document.documentElement.style.overflow="hidden";const o=setTimeout(()=>{t&&t.classList.add("glowing")},1700);e.addEventListener("animationend",i=>{i.animationName==="introOverlayOut"&&(document.documentElement.style.overflow="",e.classList.add("logo-intro--done"),requestAnimationFrame(()=>e.remove()),clearTimeout(o))}),setTimeout(()=>{document.getElementById("logo-intro")&&(document.documentElement.style.overflow="",e.remove())},5e3)}const ee="?v=f2e6a30c";Ke();document.addEventListener("DOMContentLoaded",()=>{tt(),ot(),it();const e=document.getElementById("current-year");e&&(e.textContent=new Date().getFullYear()),x(),at(),ge({home:st,recipe:Be,category:lt,cottura:async(t,o)=>{const{renderCottura:i}=await D(async()=>{const{renderCottura:a}=await import("./pagina-CZLXw_1y.js");return{renderCottura:a}},__vite__mapDeps([1,2]));return i(t,o)}}),me()});function tt(){const e=document.getElementById("navbar");if(!e)return;const t=()=>e.classList.toggle("scrolled",window.scrollY>50);window.addEventListener("scroll",t,{passive:!0}),t()}function ot(){const e=document.getElementById("theme-toggle");e&&(e.addEventListener("click",()=>{const o=document.documentElement.getAttribute("data-theme")==="dark"?"light":"dark";e.classList.add("theme-toggle--switching"),setTimeout(()=>e.classList.remove("theme-toggle--switching"),400),document.documentElement.setAttribute("data-theme",o),localStorage.setItem("theme",o)}),window.matchMedia("(prefers-color-scheme: dark)").addEventListener("change",t=>{localStorage.getItem("theme")||document.documentElement.setAttribute("data-theme",t.matches?"dark":"light")}))}function it(){const e=document.getElementById("hamburger"),t=document.getElementById("nav-links");!e||!t||(e.addEventListener("click",()=>{e.classList.toggle("open"),t.classList.toggle("open")}),t.querySelectorAll("a").forEach(o=>{o.addEventListener("click",()=>{e.classList.remove("open"),t.classList.remove("open")})}),document.addEventListener("click",o=>{!e.contains(o.target)&&!t.contains(o.target)&&(e.classList.remove("open"),t.classList.remove("open"))}))}let E=null;function rt(e){const t=new URL(m,window.location.origin),o=i=>!i||/^([a-z]+:|\/\/|\/|#)/i.test(i)?i:new URL(i,t).pathname;e.querySelectorAll("[src], [href], [srcset]").forEach(i=>{["src","href"].forEach(r=>{const n=i.getAttribute(r);n&&i.setAttribute(r,o(n))});const a=i.getAttribute("srcset");a&&i.setAttribute("srcset",a.split(",").map(r=>{const[n,...s]=r.trim().split(/\s+/);return[o(n),...s].join(" ")}).join(", "))})}function te(e,t,o){const i=e.cloneNode(!0);return rt(i),{html:i.innerHTML,title:t,description:o}}function at(){const e=document.getElementById("app");e?.querySelector("#ricette")&&(E=te(e,document.title,document.querySelector('meta[name="description"]')?.getAttribute("content")||""))}async function nt(){if(E)return E;const e=await fetch(m),t=new DOMParser().parseFromString(await e.text(),"text/html"),o=t.getElementById("app");if(!o)throw new Error("index.html non contiene #app");return E=te(o,t.title,t.querySelector('meta[name="description"]')?.getAttribute("content")||""),E}async function st(e){if(!e.querySelector("#ricette"))try{const o=await nt();e.innerHTML=o.html}catch(o){console.error("Impossibile ricostruire la homepage:",o),window.location.assign(m);return}const t=E;if(t){document.title=t.title;const o=document.querySelector('meta[name="description"]');o&&o.setAttribute("content",t.description)}x(),ut(),R()}const C=12,ct=Ee;let g={allRecipes:[],filteredRecipes:[],displayedCount:C,viewMode:"grid",sortType:"az",searchQuery:"",categoryDir:""};async function lt(e,{category:t}){const o=ct[t];if(!o){document.title="Categoria non trovata — Ricettario Lab",e.innerHTML=`
      <div class="container" style="padding: 120px 0; text-align: center;">
        <h1>${p("prohibited",28)} Categoria non trovata</h1>
        <p style="color: var(--color-text-muted);">La categoria "${t}" non esiste (o non esiste più).</p>
        <p><a href="${m}#ricette" data-link>← Vedi tutte le ricette</a></p>
      </div>`,x();return}document.title=`${o.title} — Il Ricettario`;const i=document.querySelector('meta[name="description"]');i&&i.setAttribute("content",o.desc),g={allRecipes:[],filteredRecipes:[],displayedCount:C,viewMode:localStorage.getItem("catViewMode")||"grid",sortType:"az",searchQuery:"",categoryDir:t},e.innerHTML=`
      ...
      <div class="container">
        ...
        <div class="category-toolbar" id="category-toolbar">
          ...
          <div class="category-toolbar__views">
            <button class="view-toggle-btn ${g.viewMode==="grid"?"active":""}" data-view="grid" aria-label="Vista griglia">
              <i data-lucide="grid-3x3" style="width:16px;height:16px"></i>
            </button>
            <button class="view-toggle-btn ${g.viewMode==="list"?"active":""}" data-view="list" aria-label="Vista lista">
              <i data-lucide="list" style="width:16px;height:16px"></i>
            </button>
          </div>
        </div>

        <div class="category-grid ${g.viewMode==="list"?"category-grid--list":""}" id="category-grid">
          ${pt(6)}
        </div>
  ...
  `,x();try{const r=await(await fetch(`${m}recipes.json${ee}`)).json();g.allRecipes=r.recipes.filter(c=>c.categoryDir===t||c.category===o.name),g.allRecipes.sort((c,u)=>(c.title||"").localeCompare(u.title||"","it")),g.filteredRecipes=[...g.allRecipes];const n=g.allRecipes.find(c=>c.image);if(n){const c=document.getElementById("category-hero");c&&(c.style.backgroundImage=`url('${m}${n.image}')`)}const s=document.getElementById("recipe-count");s&&(s.innerHTML=`${p("bullseye",16)} ${g.allRecipes.length} ricett${g.allRecipes.length===1?"a":"e"}`),P(),dt(e),R(),T()}catch(a){console.error("Errore caricamento categoria:",a);const r=document.getElementById("category-grid");r&&(r.innerHTML=`<div class="category-empty"><div class="category-empty__icon">${p("prohibited",32)}</div><p>Errore nel caricamento delle ricette.</p></div>`)}}function dt(e){const t=document.getElementById("category-search");let o;t&&t.addEventListener("input",()=>{clearTimeout(o),o=setTimeout(()=>{g.searchQuery=t.value.toLowerCase().trim(),g.displayedCount=C,N(),P()},150)});const i=e.querySelectorAll(".category-toolbar__sort-btn");i.forEach(r=>{r.addEventListener("click",()=>{i.forEach(n=>n.classList.remove("active")),r.classList.add("active"),g.sortType=r.dataset.sort,g.displayedCount=C,N(),P()})});const a=e.querySelectorAll(".view-toggle-btn");a.forEach(r=>{r.addEventListener("click",()=>{a.forEach(s=>s.classList.remove("active")),r.classList.add("active"),g.viewMode=r.dataset.view,localStorage.setItem("catViewMode",g.viewMode);const n=document.getElementById("category-grid");n&&n.classList.toggle("category-grid--list",g.viewMode==="list")})})}function N(){let e=[...g.allRecipes];g.searchQuery&&(e=e.filter(t=>{const o=(t.title||"").toLowerCase(),i=(t.description||"").toLowerCase();return o.includes(g.searchQuery)||i.includes(g.searchQuery)})),g.sortType==="az"?e.sort((t,o)=>(t.title||"").localeCompare(o.title||"","it")):g.sortType==="hydration"&&e.sort((t,o)=>(parseInt(o.hydration)||0)-(parseInt(t.hydration)||0)),g.filteredRecipes=e}function P(){const e=document.getElementById("category-grid"),t=document.getElementById("load-more-container");if(!e)return;const{filteredRecipes:o,displayedCount:i,categoryDir:a}=g,r=o.slice(0,i),n=o.length,s=document.getElementById("results-counter");if(s&&(g.searchQuery?s.innerHTML=`<strong>${n}</strong> risultat${n===1?"o":"i"}`:s.innerHTML=`<strong>${Math.min(i,n)}</strong> di <strong>${n}</strong>`),n===0){e.innerHTML=`
      ...
      </div>`,t&&(t.innerHTML=""),x();return}if(e.innerHTML=r.map((c,u)=>`
      <a href="${`${m}ricette/${c.categoryDir||a}/${c.slug}`}" class="category-card" data-link
         data-title="${(c.title||"").toLowerCase()}"
         data-hydration="${parseInt(c.hydration)||0}">
        <div class="category-card__image-wrapper">
          ${c.image?X(`${m}${c.image}`,c.title,"category-card__image","lazy"):""}
      ...
      </a>`).join(""),t)if(i<n){const c=n-i,u=Math.round(i/n*100);t.innerHTML=`
        <div class="load-more-wrapper">
          ...
          <div class="load-more-bar"><div class="load-more-bar__fill" style="width: ${u}%"></div></div>
        </div>`,document.getElementById("load-more-btn")?.addEventListener("click",()=>{g.displayedCount+=C,P(),setTimeout(()=>{const _=e.querySelectorAll(".category-card")[i];_&&_.scrollIntoView({behavior:"smooth",block:"center"})},100),T()})}else t.innerHTML="";x(),T()}function pt(e){return Array.from({length:e},()=>`
    ...
    </div>`).join("")}function G(e,t,o,i,a){const r=document.createElement("div");r.className="category-row reveal",r.dataset.category=t,r.innerHTML=`
        ...
        ${a.map(l=>`
          <a href="${l.href.replace(".html","")}" class="recipe-card--compact" data-link data-title="${l.title.toLowerCase()}" data-category="${l.category}">
            <div class="recipe-card--compact__image-wrapper">
              ${l.image?X(l.image,l.title,"recipe-card--compact__image","lazy"):""}
            </div>
  ...
  `,e.appendChild(r);const n=r.querySelector(".category-row__carousel"),s=r.querySelector(".category-row__carousel-wrapper"),c=r.querySelector(".carousel-arrow--prev"),u=r.querySelector(".carousel-arrow--next"),f=276,_=()=>{const{scrollLeft:l,scrollWidth:v,clientWidth:d}=n;s.classList.toggle("has-scroll-left",l>10),s.classList.toggle("has-scroll-right",l<v-d-10),c.disabled=l<=10,u.disabled=l>=v-d-10};n.addEventListener("scroll",_,{passive:!0}),requestAnimationFrame(_),c.addEventListener("click",()=>n.scrollBy({left:-f*3,behavior:"smooth"})),u.addEventListener("click",()=>n.scrollBy({left:f*3,behavior:"smooth"}))}function ut(){const e=document.getElementById("recipe-carousels");if(!e)return;const t=xe.map(o=>{const i=B[o];return{key:i.name,emoji:i.emoji,dir:i.dir}});fetch(`${m}recipes.json${ee}`).then(o=>o.json()).then(o=>{e.innerHTML="";const i={};o.recipes.forEach(r=>{i[r.category]||(i[r.category]=[]),i[r.category].push(r)}),t.forEach(r=>{const n=i[r.key];!n||n.length===0||G(e,r.key,r.emoji,r.dir,n)});const a=new Set(t.map(r=>r.key));Object.keys(i).forEach(r=>{if(a.has(r))return;const n=i[r];if(!n||n.length===0)return;const s=r.toLowerCase(),c=J[r]||"fork-and-knife";G(e,r,c,s,n)}),R(),gt(),T()}).catch(o=>{console.error("Errore caricamento recipes.json:",o),e.innerHTML='<p style="text-align:center; color: var(--color-text-muted);">Errore nel caricamento delle ricette.</p>'})}function gt(){const e=document.getElementById("search-input");e&&(e.addEventListener("input",()=>{const t=e.value.toLowerCase().trim(),o=document.querySelectorAll(".recipe-card--compact"),i=document.querySelectorAll(".category-row");o.forEach(a=>{const r=a.dataset.title||a.textContent.toLowerCase();a.classList.toggle("hidden",!!(t&&!r.includes(t)))}),i.forEach(a=>{const r=a.querySelectorAll(".recipe-card--compact:not(.hidden)");a.classList.toggle("hidden",r.length===0)})}),document.addEventListener("keydown",t=>{t.key==="/"&&document.activeElement!==e&&(t.preventDefault(),e.focus(),e.scrollIntoView({behavior:"smooth",block:"center"})),t.key==="Escape"&&document.activeElement===e&&(e.value="",e.dispatchEvent(new Event("input")),e.blur())}))}export{m as B,M as n};
