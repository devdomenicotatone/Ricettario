const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/logo-intro-Cp8JEbss.css","assets/pagina-CKay0Oj0.js","assets/pagina-C4mDmozo.css"])))=>i.map(i=>d[i]);
(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const a of document.querySelectorAll('link[rel="modulepreload"]'))i(a);new MutationObserver(a=>{for(const r of a)if(r.type==="childList")for(const n of r.addedNodes)n.tagName==="LINK"&&n.rel==="modulepreload"&&i(n)}).observe(document,{childList:!0,subtree:!0});function o(a){const r={};return a.integrity&&(r.integrity=a.integrity),a.referrerPolicy&&(r.referrerPolicy=a.referrerPolicy),a.crossOrigin==="use-credentials"?r.credentials="include":a.crossOrigin==="anonymous"?r.credentials="omit":r.credentials="same-origin",r}function i(a){if(a.ep)return;a.ep=!0;const r=o(a);fetch(a.href,r)}})();const ge="modulepreload",me=function(e){return"/Ricettario/"+e},O={},D=function(t,o,i){let a=Promise.resolve();if(o&&o.length>0){let n=function(g){return Promise.all(g.map(f=>Promise.resolve(f).then(y=>({status:"fulfilled",value:y}),y=>({status:"rejected",reason:y}))))};document.getElementsByTagName("link");const s=document.querySelector("meta[property=csp-nonce]"),l=s?.nonce||s?.getAttribute("nonce");a=n(o.map(g=>{if(g=me(g),g in O)return;O[g]=!0;const f=g.endsWith(".css"),y=f?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${g}"]${y}`))return;const d=document.createElement("link");if(d.rel=f?"stylesheet":ge,f||(d.as="script"),d.crossOrigin="",d.href=g,l&&d.setAttribute("nonce",l),document.head.appendChild(d),f)return new Promise((w,p)=>{d.addEventListener("load",w),d.addEventListener("error",()=>p(new Error(`Unable to preload CSS for ${g}`)))})}))}function r(n){const s=new Event("vite:preloadError",{cancelable:!0});if(s.payload=n,window.dispatchEvent(s),!s.defaultPrevented)throw n}return a.then(n=>{for(const s of n||[])s.status==="rejected"&&r(s.reason);return t().catch(r)})},h="/Ricettario/";let W={};function he(e){W=e}function X(e){let t=e.replace(h,"").replace(/^\/+|\/+$/g,"");if(!t||t==="index.html")return{type:"home",params:{}};const o=t.match(/^ricette\/([^/]+)\/([^/]+?)(?:\.html)?$/);if(o)return{type:"recipe",params:{category:o[1],slug:o[2]}};const i=t.match(/^ricette\/([^/]+)\/?$/);if(i)return{type:"category",params:{category:i[1]}};const a=t.match(/^cottura(?:\/([^/]+?))?(?:\.html)?$/);return a?{type:"cottura",params:{config:a[1]||null}}:{type:"home",params:{}}}let F=!0;function H(){const e=document.getElementById("contenuto");e&&e.focus({preventScroll:!0});const t=document.getElementById("annuncio-pagina");if(!t)return;const o=document.title.replace(/\s*[—-]\s*(Il )?Ricettario( Lab)?\s*$/i,"").trim();t.textContent="",setTimeout(()=>{t.textContent=o?`${o}, pagina caricata`:"Pagina caricata"},100)}async function I(e,t=!0){const o=new URL(e,window.location.origin);t&&history.pushState(null,"",o.pathname+o.search);const i=X(o.pathname),a=document.getElementById("app");if(!a)return;window.scrollTo(0,0);const r=F;if(F=!1,"startViewTransition"in document){const n=document.startViewTransition(async()=>{await q(i,a)});r||n.updateCallbackDone.then(H).catch(()=>{})}else await q(i,a),r||H()}async function q(e,t){const o=W[e.type];o?await o(t,e.params):t.innerHTML=`<div class="container" style="padding: 80px 0; text-align: center;">
      <h2>Pagina non trovata</h2>
      <p><a href="${h}" data-link>← Torna alla Home</a></p>
    </div>`,R()}function R(){const e=document.querySelectorAll(".reveal:not(.visible)");if(e.length===0)return;const t=new IntersectionObserver(o=>{o.forEach(i=>{i.isIntersecting&&(i.target.classList.add("visible"),t.unobserve(i.target))})},{threshold:.1,rootMargin:"0px 0px -50px 0px"});e.forEach(o=>t.observe(o))}function fe(){const e=sessionStorage.getItem("spa-redirect");e&&(sessionStorage.removeItem("spa-redirect"),history.replaceState(null,"",e)),document.addEventListener("click",t=>{const o=t.target.closest("a[href]");if(!o)return;const i=o.getAttribute("href"),a=o.getAttribute("data-nav-section");if(a){if(X(window.location.pathname).type!=="home"){t.preventDefault(),I(h).then(()=>{setTimeout(()=>{const s=document.getElementById(a);s&&s.scrollIntoView({behavior:"smooth"})},100)});return}return}if(!i||i.startsWith("http")||i.startsWith("#")||i.startsWith("mailto:")||i.startsWith("tel:")||o.target==="_blank")return;t.preventDefault();const r=new URL(i,window.location.href);I(r.href)}),window.addEventListener("popstate",()=>{I(window.location.href,!1)}),I(window.location.href,!1)}function c(e){return e==null?"":String(e).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;")}const _=c;function Y(e){const t=e.replace(/\.(jpg|jpeg|png|webp)$/i,"");return{avif:`${t}.avif`,webp:`${t}.webp`}}function Q(e,t,o="",i="lazy"){if(!e)return"";const{avif:a,webp:r}=Y(e),n=o?` class="${_(o)}"`:"",s=i?` loading="${_(i)}"`:"";return`<picture>
  <source srcset="${_(a)}" type="image/avif">
  <source srcset="${_(r)}" type="image/webp">
  <img src="${_(r)}" alt="${_(t)}"${n}${s}>
</picture>`}function _e(e,t){if(!e)return"";const{avif:o,webp:i}=Y(e);return`<picture class="recipe-hero__picture">
  <source srcset="${_(o)}" type="image/avif">
  <source srcset="${_(i)}" type="image/webp">
  <img src="${_(i)}" alt="${_(t)}" class="recipe-hero__img">
</picture>`}const J="ricettario_fatte";function j(){try{const e=localStorage.getItem(J);return e?new Set(JSON.parse(e)):new Set}catch{return new Set}}function ye(e){localStorage.setItem(J,JSON.stringify([...e]))}function be(e){return j().has(e)}function ve(e){const t=j(),o=!t.has(e);return o?t.add(e):t.delete(e),ye(t),o}function T(){const e=j();if(e.size===0)return;document.querySelectorAll(".recipe-card--compact, .category-card").forEach(o=>{const i=o.getAttribute("href")||"",a=new URL(i,location.origin).pathname.split("/").filter(Boolean).pop();if(a&&e.has(a)&&!o.querySelector(".made-badge")){const r=document.createElement("span");r.className="made-badge",r.textContent="✓",r.title="Ricetta già fatta!";const n=o.querySelector(".recipe-card--compact__image-wrapper, .category-card__image-wrapper");n&&n.appendChild(r)}})}function we(e){const t=document.getElementById("made-toggle");if(!t)return;const o=i=>{t.classList.toggle("made-toggle--active",i),t.innerHTML=i?'<span class="made-toggle__icon">✓</span> <span class="made-toggle__label">Fatta!</span>':'<span class="made-toggle__icon">○</span> <span class="made-toggle__label">Segna come fatta</span>',t.title=i?"Clicca per rimuovere":"Segna questa ricetta come fatta"};o(be(e)),t.addEventListener("click",i=>{i.preventDefault();const a=ve(e);o(a),t.classList.add("made-toggle--pop"),setTimeout(()=>t.classList.remove("made-toggle--pop"),400)})}const $e={"arrow-up-right":'<path d="M7 7h10v10"/><path d="M7 17 17 7"/>',"chevron-down":'<path d="m6 9 6 6 6-6"/>',"grid-3x3":'<rect width="18" height="18" x="3" y="3" rx="2"/><path d="M3 9h18"/><path d="M3 15h18"/><path d="M9 3v18"/><path d="M15 3v18"/>',list:'<path d="M3 5h.01"/><path d="M3 12h.01"/><path d="M3 19h.01"/><path d="M8 5h13"/><path d="M8 12h13"/><path d="M8 19h13"/>',microscope:'<path d="M6 18h8"/><path d="M3 22h18"/><path d="M14 22a7 7 0 1 0 0-14h-1"/><path d="M9 14h2"/><path d="M9 12a2 2 0 0 1-2-2V6h6v4a2 2 0 0 1-2 2Z"/><path d="M12 6V3a1 1 0 0 0-1-1H9a1 1 0 0 0-1 1v3"/>',moon:'<path d="M20.985 12.486a9 9 0 1 1-9.473-9.472c.405-.022.617.46.402.803a6 6 0 0 0 8.268 8.268c.344-.215.825-.004.803.401"/>',search:'<path d="m21 21-4.34-4.34"/><circle cx="11" cy="11" r="8"/>',sun:'<circle cx="12" cy="12" r="4"/><path d="M12 2v2"/><path d="M12 20v2"/><path d="m4.93 4.93 1.41 1.41"/><path d="m17.66 17.66 1.41 1.41"/><path d="M2 12h2"/><path d="M20 12h2"/><path d="m6.34 17.66-1.41 1.41"/><path d="m19.07 4.93-1.41 1.41"/>'},Z="http://www.w3.org/2000/svg",xe={xmlns:Z,width:"24",height:"24",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor","stroke-width":"2","stroke-linecap":"round","stroke-linejoin":"round"};function Ee(e=document){for(const t of e.querySelectorAll("[data-lucide]")){const o=t.getAttribute("data-lucide"),i=$e[o];if(!i){console.warn(`[icons] icona "${o}" non disponibile: aggiungila a js/icons.js`);continue}const a=document.createElementNS(Z,"svg");for(const[r,n]of Object.entries(xe))a.setAttribute(r,n);for(const r of t.attributes)r.name!=="data-lucide"&&a.setAttribute(r.name,r.value);a.setAttribute("class",`lucide lucide-${o}${t.className?" "+t.className:""}`),a.innerHTML=i,t.replaceWith(a)}}const B={pane:{name:"Pane",dir:"pane",emoji:"baguette-bread",unicode:"🥖",title:"Pane Artigianale",desc:"Ricette di pane ad alta idratazione — ciabatta, filone, baguette e pane speciale."},pizza:{name:"Pizza",dir:"pizza",emoji:"pizza",unicode:"🍕",title:"Pizza Artigianale",desc:"Pizze con lievitazione lunga — napoletana, in teglia, canotto e pinsa romana."},primi:{name:"Primi",dir:"primi",emoji:"tomato",unicode:"🥣",title:"Primi Piatti",desc:"Primi piatti della tradizione — gnocchi, polenta, zuppe e piatti unici caldi."},lievitati:{name:"Lievitati",dir:"lievitati",emoji:"croissant",unicode:"🥐",title:"Lievitati Dolci e Salati",desc:"Brioche, cornetti, panettone, burger buns e rosticceria."},focaccia:{name:"Focaccia",dir:"focaccia",emoji:"flatbread",unicode:"🫓",title:"Focaccia Artigianale",desc:"Focacce ad alta idratazione — genovese, barese, pugliese e varianti creative."},dolci:{name:"Dolci",dir:"dolci",emoji:"shortcake",unicode:"🍪",title:"Dolci e Pasticceria",desc:"Dolci tradizionali, frolle, biscotti e pasticceria artigianale."},conserve:{name:"Conserve",dir:"conserve",emoji:"canned-food",unicode:"🫙",title:"Conserve e Preparazioni",desc:"Conserve fatte in casa — dadi vegetali, salse, sottoli e preparazioni base."},condimenti:{name:"Condimenti",dir:"condimenti",emoji:"herb",unicode:"🌿",title:"Condimenti",desc:"Salse, pesti e condimenti artigianali per ogni piatto."},secondi_piatti:{name:"Secondi Piatti",dir:"secondi-piatti",emoji:"fork-and-knife",unicode:"🍲",title:"Secondi Piatti",desc:"Esplora ricette complete e saporite per i tuoi secondi piatti: carne, pesce, legumi e verdure."}},Ce=["primi","pane","pizza","lievitati","dolci","focaccia","conserve","condimenti","secondi_piatti"],ke=Object.fromEntries(Object.values(B).map(e=>[e.dir,e])),Le=Object.fromEntries(Object.values(B).map(e=>[e.name,e.emoji]));Object.values(B).map(e=>e.name);const Se={"shopping-cart":"shopping-cart","balance-scale":"balance-scale",peanuts:"peanuts",gear:"gear","sheaf-of-rice":"flatbread",fire:"fire","light-bulb":"light-bulb","open-book":"open-book",prohibited:"prohibited",warning:"warning",droplet:"droplet",thermometer:"thermometer",stopwatch:"stopwatch",wrench:"wrench","baguette-bread":"baguette-bread",pizza:"pizza",spaghetti:"spaghetti",croissant:"croissant",cookie:"cookie",flatbread:"flatbread",shortcake:"shortcake","canned-food":"canned-food",herb:"herb","fork-and-knife":"fork-and-knife",star:"star",house:"house","high-voltage":"high-voltage",bullseye:"bullseye",package:"package",tomato:"tomato"};function u(e,t=20,o=""){const i=Se[e]||e,a=`fluent-emoji${o?" "+o:""}`;return`<img src="${h}images/emoji/${i}.png" width="${t}" height="${t}" alt="" class="${a}" loading="lazy">`}const K=Le;function Ae(e,t=20){const o=K[e];return o?u(o,t):""}function E(){Ee()}const Me=["n/a","na","nessuna","nessuno","none","null","0","-","—"];function x(e){if(e==null)return!1;const t=String(e).trim();return t!==""&&!Me.includes(t.toLowerCase())}const Ie=["immagine esistente","caricata manualmente","provenienza non documentata"],Te=["pexels","unsplash","pixabay","wikimedia","openverse","flickr"],N={"pexels license":"https://www.pexels.com/license/","unsplash license":"https://unsplash.com/license","pixabay license":"https://pixabay.com/service/license-summary/"};function Pe(e){const t=String(e??"").trim().toLowerCase();if(!t)return null;if(N[t])return N[t];const o=t.replace(/^cc\s+/,"");if(/^cc0\b/.test(o)||o==="zero")return"https://creativecommons.org/publicdomain/zero/1.0/";if(/^(public domain|pdm|dominio pubblico)\b/.test(o))return"https://creativecommons.org/publicdomain/mark/1.0/";const i=o.match(/^(by(?:-nc)?(?:-sa|-nd)?)\s+(\d\.\d)$/);return i?`https://creativecommons.org/licenses/${i[1]}/${i[2]}/`:null}function Re(e){const t=String(e??"").trim();if(!/^https:\/\//i.test(t))return null;const o=t.match(/^https:\/\/upload\.wikimedia\.org\/wikipedia\/[a-z-]+\/(?:thumb\/)?[0-9a-f]\/[0-9a-f]{2}\/([^/?#]+)/i);if(o)return`https://commons.wikimedia.org/wiki/File:${o[1]}`;const i=t.match(/^https:\/\/images\.pexels\.com\/photos\/(\d+)\//i);return i?`https://www.pexels.com/photo/${i[1]}/`:/^https:\/\/(commons\.wikimedia\.org\/wiki\/|www\.pexels\.com\/photo\/|unsplash\.com\/photos\/|pixabay\.com\/[a-z-]+\/|openverse\.org\/image\/|www\.flickr\.com\/photos\/)/i.test(t)?t:null}function Be(e,t){const o=String(e??"").trim();if(!o)return null;const i=o.replace(/^📷\s*/,"").replace(/^Foto:\s*/i,"").trim();if(!i||Ie.includes(i.toLowerCase()))return null;const a=i.split(/\s+[—–]\s+/),r=a[0].trim();if(!r)return null;let n=null,s=null;if(a.length>1){const l=a.slice(1).join(" — ").trim(),g=l.match(/^(.*?)\s+via\s+(.+)$/i);g?(n=g[1].trim()||null,s=g[2].trim()):Te.includes(l.toLowerCase())?s=l:n=l||null}return{autore:r,licenza:n,fonte:s,urlLicenza:Pe(n),urlFonte:Re(t)}}function ze(e,t){const o=Be(e,t);if(!o)return"";const i=(n,s,l)=>s?`<a href="${c(s)}" target="_blank" rel="${l}">${c(n)}</a>`:c(n),a=!!(o.licenza&&!o.urlLicenza&&o.urlFonte);let r=`Foto: ${c(o.autore)}`;return o.licenza&&(r+=a?` — ${i(o.licenza,o.urlFonte,"noopener nofollow")}`:` — ${i(o.licenza,o.urlLicenza,"license noopener nofollow")}`),o.fonte?r+=` via ${i(o.fonte,a?null:o.urlFonte,"noopener nofollow")}`:o.urlFonte&&!a&&(r+=` — ${i("fonte",o.urlFonte,"noopener nofollow")}`),r}async function De(e,{category:t,slug:o}){e.innerHTML=`
    <div class="recipe-loading">
      <div class="recipe-loading__spinner"></div>
      <p>Caricamento ricetta...</p>
    </div>`;try{const i=`${h}ricette/${t}/${o}.json`,a=await fetch(i);if(!a.ok)throw new Error(`Ricetta non trovata (${a.status})`);const r=await a.json();document.title=`${r.title} — Ricettario Lab`;const n=document.querySelector('meta[name="description"]');n&&n.setAttribute("content",r.description||""),e.innerHTML=je(r,t),Qe(r),we(r.slug),Ze(),E()}catch(i){e.innerHTML=`
      ...
      </div>`}}function je(e,t){const o=Ae(e.category,22),i=e.image?`${h}${e.image.replace(/^\//,"")}`:`${h}images/ricette/${t}/${e.slug}.webp`,a=ze(e.imageAttribution,e._originalImageUrl);return`
    <!-- ═══════════ RECIPE HERO ═══════════ -->
  ...
  `}function G(e){return`<tr${e.excludeFromTotal?' data-exclude-total="true"':""}>
  ...
  </tr>`}function Oe(e){const t=e.ingredientGroups?.length>0,o=e.ingredients?.length>0;if(!t&&!o)return"";let i;return t?i=e.ingredientGroups.map(a=>{if(!a.items?.length)return"";const r=`<tr class="ingredient-section-header"><td colspan="2">${c(a.group||"Ingredienti")}</td></tr>`,n=a.items.map(G).join("");return r+n}).join(""):i=e.ingredients.map(G).join(""),`
    ...
    </div>`}function Fe(e){const t=e.suspensions.map(o=>`
    <tr>
  ...
  `).join("");return`
    ...
    </div>`:""}function qe(e){const t=e.stepsCondiment;return t?.length?`
    ...
    </div>`:""}function Ne(e){if(!e.sensoryProfile||!e.sensoryProfile.axes||e.sensoryProfile.axes.length===0)return"";const t=e.sensoryProfile.axes.reduce((n,s)=>s.value>n.value?s:n,e.sensoryProfile.axes[0]),o=e.sensoryProfile.summary?`
  ...
  `}function Ge(e){return e.flourTable?.length?`
    ...
    </div>`:""}function Ve(e){return e.alert?`
    ...
    </div>`:""}function Ue(e){if(!e.baking)return"";const t=e.baking;return`
    <div class="recipe-panel reveal recipe-panel--spaced">
      <h2 class="recipe-panel__title">
    ...
    </div>`}function We(e){return e.proTips?.length?`
    <div class="recipe-panel reveal recipe-panel--spaced">
      <h2 class="recipe-panel__title">
    ...
    </div>`:""}function Xe(e){return e.storage?.length?`
    <div class="recipe-panel reveal recipe-panel--spaced">
      <h2 class="recipe-panel__title">
    ...
    </div>`:""}function Ye(e){return e.glossary?.length?`
    <div class="recipe-panel reveal recipe-panel--spaced">
      <h2 class="recipe-panel__title">
  ...
  `}function tt(){if(sessionStorage.getItem("intro-shown"))return;if(window.matchMedia("(prefers-reduced-motion: reduce)").matches){sessionStorage.setItem("intro-shown","1");return}D(()=>Promise.resolve({}),__vite__mapDeps([0]));const e=()=>{document.body.insertAdjacentHTML("afterbegin",et()),ot(),sessionStorage.setItem("intro-shown","1")};document.body?e():document.addEventListener("DOMContentLoaded",e,{once:!0})}function ot(){const e=document.getElementById("logo-intro"),t=document.getElementById("logo-intro-logo");if(!e)return;document.documentElement.style.overflow="hidden";const o=setTimeout(()=>{t&&t.classList.add("glowing")},1700);e.addEventListener("animationend",i=>{i.animationName==="introOverlayOut"&&(document.documentElement.style.overflow="",e.classList.add("logo-intro--done"),requestAnimationFrame(()=>e.remove()),clearTimeout(o))}),setTimeout(()=>{document.getElementById("logo-intro")&&(document.documentElement.style.overflow="",e.remove())},5e3)}const oe="?v=f84e5d2e";tt();document.addEventListener("DOMContentLoaded",()=>{it(),rt(),at();const e=document.getElementById("current-year");e&&(e.textContent=new Date().getFullYear()),E(),st(),he({home:lt,recipe:De,category:pt,cottura:async(t,o)=>{const{renderCottura:i}=await D(async()=>{const{renderCottura:a}=await import("./pagina-CKay0Oj0.js");return{renderCottura:a}},__vite__mapDeps([1,2]));return i(t,o)}}),fe()});function it(){const e=document.getElementById("navbar");if(!e)return;const t=()=>e.classList.toggle("scrolled",window.scrollY>50);window.addEventListener("scroll",t,{passive:!0}),t()}function rt(){const e=document.getElementById("theme-toggle");e&&(e.addEventListener("click",()=>{const o=document.documentElement.getAttribute("data-theme")==="dark"?"light":"dark";e.classList.add("theme-toggle--switching"),setTimeout(()=>e.classList.remove("theme-toggle--switching"),400),document.documentElement.setAttribute("data-theme",o),localStorage.setItem("theme",o)}),window.matchMedia("(prefers-color-scheme: dark)").addEventListener("change",t=>{localStorage.getItem("theme")||document.documentElement.setAttribute("data-theme",t.matches?"dark":"light")}))}function at(){const e=document.getElementById("hamburger"),t=document.getElementById("nav-links");!e||!t||(e.addEventListener("click",()=>{e.classList.toggle("open"),t.classList.toggle("open")}),t.querySelectorAll("a").forEach(o=>{o.addEventListener("click",()=>{e.classList.remove("open"),t.classList.remove("open")})}),document.addEventListener("click",o=>{!e.contains(o.target)&&!t.contains(o.target)&&(e.classList.remove("open"),t.classList.remove("open"))}))}let C=null;function nt(e){const t=new URL(h,window.location.origin),o=i=>!i||/^([a-z]+:|\/\/|\/|#)/i.test(i)?i:new URL(i,t).pathname;e.querySelectorAll("[src], [href], [srcset]").forEach(i=>{["src","href"].forEach(r=>{const n=i.getAttribute(r);n&&i.setAttribute(r,o(n))});const a=i.getAttribute("srcset");a&&i.setAttribute("srcset",a.split(",").map(r=>{const[n,...s]=r.trim().split(/\s+/);return[o(n),...s].join(" ")}).join(", "))})}function ie(e,t,o){const i=e.cloneNode(!0);return nt(i),{html:i.innerHTML,title:t,description:o}}function st(){const e=document.getElementById("app");e?.querySelector("#ricette")&&(C=ie(e,document.title,document.querySelector('meta[name="description"]')?.getAttribute("content")||""))}async function ct(){if(C)return C;const e=await fetch(h),t=new DOMParser().parseFromString(await e.text(),"text/html"),o=t.getElementById("app");if(!o)throw new Error("index.html non contiene #app");return C=ie(o,t.title,t.querySelector('meta[name="description"]')?.getAttribute("content")||""),C}async function lt(e){if(!e.querySelector("#ricette"))try{const o=await ct();e.innerHTML=o.html}catch(o){console.error("Impossibile ricostruire la homepage:",o),window.location.assign(h);return}const t=C;if(t){document.title=t.title;const o=document.querySelector('meta[name="description"]');o&&o.setAttribute("content",t.description)}E(),mt(),R()}const k=12,dt=ke;let m={allRecipes:[],filteredRecipes:[],displayedCount:k,viewMode:"grid",sortType:"az",searchQuery:"",categoryDir:""};async function pt(e,{category:t}){const o=dt[t];if(!o){document.title="Categoria non trovata — Ricettario Lab",e.innerHTML=`
      <div class="container" style="padding: 120px 0; text-align: center;">
  ...
  `,E();try{const r=await(await fetch(`${h}recipes.json${oe}`)).json();m.allRecipes=r.recipes.filter(l=>l.categoryDir===t||l.category===o.name),m.allRecipes.sort((l,g)=>(l.title||"").localeCompare(g.title||"","it")),m.filteredRecipes=[...m.allRecipes];const n=m.allRecipes.find(l=>l.image);if(n){const l=document.getElementById("category-hero");l&&(l.style.backgroundImage=`url('${h}${n.image}')`)}const s=document.getElementById("recipe-count");s&&(s.innerHTML=`${u("bullseye",16)} ${m.allRecipes.length} ricett${m.allRecipes.length===1?"a":"e"}`),P(),ut(e),R(),T()}catch(a){console.error("Errore caricamento categoria:",a);const r=document.getElementById("category-grid");r&&(r.innerHTML=`<div class="category-empty"><div class="category-empty__icon">${u("prohibited",32)}</div><p>Errore nel caricamento delle ricette.</p></div>`)}}function ut(e){const t=document.getElementById("category-search");let o;t&&t.addEventListener("input",()=>{clearTimeout(o),o=setTimeout(()=>{m.searchQuery=t.value.toLowerCase().trim(),m.displayedCount=k,V(),P()},150)});const i=e.querySelectorAll(".category-toolbar__sort-btn");i.forEach(r=>{r.addEventListener("click",()=>{i.forEach(n=>n.classList.remove("active")),r.classList.add("active"),m.sortType=r.dataset.sort,m.displayedCount=k,V(),P()})});const a=e.querySelectorAll(".view-toggle-btn");a.forEach(r=>{r.addEventListener("click",()=>{a.forEach(s=>s.classList.remove("active")),r.classList.add("active"),m.viewMode=r.dataset.view,localStorage.setItem("catViewMode",m.viewMode);const n=document.getElementById("category-grid");n&&n.classList.toggle("category-grid--list",m.viewMode==="list")})})}function V(){let e=[...m.allRecipes];m.searchQuery&&(e=e.filter(t=>{const o=(t.title||"").toLowerCase(),i=(t.description||"").toLowerCase();return o.includes(m.searchQuery)||i.includes(m.searchQuery)})),m.sortType==="az"?e.sort((t,o)=>(t.title||"").localeCompare(o.title||"","it")):m.sortType==="hydration"&&e.sort((t,o)=>(parseInt(o.hydration)||0)-(parseInt(t.hydration)||0)),m.filteredRecipes=e}function P(){const e=document.getElementById("category-grid"),t=document.getElementById("load-more-container");if(!e)return;const{filteredRecipes:o,displayedCount:i,categoryDir:a}=m,r=o.slice(0,i),n=o.length,s=document.getElementById("results-counter");if(s&&(m.searchQuery?s.innerHTML=`<strong>${n}</strong> risultat${n===1?"o":"i"}`:s.innerHTML=`<strong>${Math.min(i,n)}</strong> di <strong>${n}</strong>`),n===0){e.innerHTML=`
      ...
      <a href="${_(f)}" class="category-card" data-link
        ...
        <div class="category-card__image-wrapper">
          ${l.image?Q(`${h}${l.image}`,l.title,"category-card__image","lazy"):""}
        ...
        </div>`,document.getElementById("load-more-btn")?.addEventListener("click",()=>{m.displayedCount+=k,P(),setTimeout(()=>{const y=e.querySelectorAll(".category-card")[i];y&&y.scrollIntoView({behavior:"smooth",block:"center"})},100),T()})}else t.innerHTML="";E(),T()}function gt(e){return Array.from({length:e},()=>`
