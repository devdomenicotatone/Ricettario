const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/logo-intro-DWh29O1b.css","assets/pagina-BK0uCMKY.js","assets/pagina-x-fbNz_H.css"])))=>i.map(i=>d[i]);
(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const r of document.querySelectorAll('link[rel="modulepreload"]'))i(r);new MutationObserver(r=>{for(const a of r)if(a.type==="childList")for(const n of a.addedNodes)n.tagName==="LINK"&&n.rel==="modulepreload"&&i(n)}).observe(document,{childList:!0,subtree:!0});function o(r){const a={};return r.integrity&&(a.integrity=r.integrity),r.referrerPolicy&&(a.referrerPolicy=r.referrerPolicy),r.crossOrigin==="use-credentials"?a.credentials="include":r.crossOrigin==="anonymous"?a.credentials="omit":a.credentials="same-origin",a}function i(r){if(r.ep)return;r.ep=!0;const a=o(r);fetch(r.href,a)}})();const ve="modulepreload",$e=function(e){return"/Ricettario/"+e},q={},O=function(t,o,i){let r=Promise.resolve();if(o&&o.length>0){let n=function(d){return Promise.all(d.map(g=>Promise.resolve(g).then(f=>({status:"fulfilled",value:f}),f=>({status:"rejected",reason:f}))))};document.getElementsByTagName("link");const s=document.querySelector("meta[property=csp-nonce]"),l=s?.nonce||s?.getAttribute("nonce");r=n(o.map(d=>{if(d=$e(d),d in q)return;q[d]=!0;const g=d.endsWith(".css"),f=g?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${d}"]${f}`))return;const b=document.createElement("link");if(b.rel=g?"stylesheet":ve,g||(b.as="script"),b.crossOrigin="",b.href=d,l&&b.setAttribute("nonce",l),document.head.appendChild(b),g)return new Promise((_,p)=>{b.addEventListener("load",_),b.addEventListener("error",()=>p(new Error(`Unable to preload CSS for ${d}`)))})}))}function a(n){const s=new Event("vite:preloadError",{cancelable:!0});if(s.payload=n,window.dispatchEvent(s),!s.defaultPrevented)throw n}return r.then(n=>{for(const s of n||[])s.status==="rejected"&&a(s.reason);return t().catch(a)})};function we(e){const t=document.getElementById("annuncio-pagina");!t||!e||(t.textContent="",setTimeout(()=>{t.textContent=e},100))}const R={pane:{name:"Pane",dir:"pane",emoji:"baguette-bread",unicode:"🥖",title:"Pane Artigianale",desc:"Ricette di pane ad alta idratazione — ciabatta, filone, baguette e pane speciale."},pizza:{name:"Pizza",dir:"pizza",emoji:"pizza",unicode:"🍕",title:"Pizza Artigianale",desc:"Pizze con lievitazione lunga — napoletana, in teglia, canotto e pinsa romana."},primi:{name:"Primi",dir:"primi",emoji:"tomato",unicode:"🥣",title:"Primi Piatti",desc:"Primi piatti della tradizione — gnocchi, polenta, zuppe e piatti unici caldi."},lievitati:{name:"Lievitati",dir:"lievitati",emoji:"croissant",unicode:"🥐",title:"Lievitati Dolci e Salati",desc:"Brioche, cornetti, panettone, burger buns e rosticceria."},focaccia:{name:"Focaccia",dir:"focaccia",emoji:"flatbread",unicode:"🫓",title:"Focaccia Artigianale",desc:"Focacce ad alta idratazione — genovese, barese, pugliese e varianti creative."},dolci:{name:"Dolci",dir:"dolci",emoji:"shortcake",unicode:"🍪",title:"Dolci e Pasticceria",desc:"Dolci tradizionali, frolle, biscotti e pasticceria artigianale."},conserve:{name:"Conserve",dir:"conserve",emoji:"canned-food",unicode:"🫙",title:"Conserve e Preparazioni",desc:"Conserve fatte in casa — dadi vegetali, salse, sottoli e preparazioni base."},condimenti:{name:"Condimenti",dir:"condimenti",emoji:"herb",unicode:"🌿",title:"Condimenti",desc:"Salse, pesti e condimenti artigianali per ogni piatto."},secondi_piatti:{name:"Secondi Piatti",dir:"secondi-piatti",emoji:"fork-and-knife",unicode:"🍲",title:"Secondi Piatti",desc:"Esplora ricette complete e saporite per i tuoi secondi piatti: carne, pesce, legumi e verdure."}},xe=["primi","pane","pizza","lievitati","dolci","focaccia","conserve","condimenti","secondi_piatti"],Z=Object.fromEntries(Object.values(R).map(e=>[e.dir,e])),J=Object.fromEntries(Object.values(R).map(e=>[e.name,e.emoji]));Object.values(R).map(e=>e.name);const Ee={"shopping-cart":"shopping-cart","balance-scale":"balance-scale",peanuts:"peanuts",gear:"gear","sheaf-of-rice":"flatbread",fire:"fire","light-bulb":"light-bulb","open-book":"open-book",prohibited:"prohibited",warning:"warning",droplet:"droplet",thermometer:"thermometer",stopwatch:"stopwatch",wrench:"wrench","baguette-bread":"baguette-bread",pizza:"pizza",spaghetti:"spaghetti",croissant:"croissant",cookie:"cookie",flatbread:"flatbread",shortcake:"shortcake","canned-food":"canned-food",herb:"herb","fork-and-knife":"fork-and-knife",star:"star",house:"house","high-voltage":"high-voltage",bullseye:"bullseye",package:"package",tomato:"tomato"};function w(e,t,o=20,i=""){const r=Ee[t]||t,a=`fluent-emoji${i?" "+i:""}`;return`<img src="${e}images/emoji/${r}.png" width="${o}" height="${o}" alt="" class="${a}" loading="lazy">`}function Ce(e,t,o=20){const i=J[t];return i?w(e,i,o):""}function c(e){return e==null?"":String(e).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;")}const h=c;function z(e,{base:t,titolo:o="Pagina non trovata",dettaglio:i="",uscite:r}={}){document.title=`${o} — Ricettario Lab`;const[a,...n]=r?.length?r:[{href:t,testo:"Torna alla home"},{href:`${t}#ricette`,testo:"Vedi tutte le ricette"}],s=(l,d="")=>`<a href="${c(l.href)}" data-link${d?` class="${d}"`:""}>${c(l.testo)}</a>`;e.innerHTML=`
    <div class="container" style="padding: 120px 0; text-align: center;">
      <h1>${w(t,"prohibited",28)} ${c(o)}</h1>
      ${i?`<p style="color: var(--color-text-muted);">${c(i)}</p>`:""}
      <p>${s(a,"btn-back")}</p>
      ${n.length?`<p>${n.map(l=>s(l)).join(" · ")}</p>`:""}
    </div>`}const m="/Ricettario/";let K={};function ke(e){K=e}function ee(e){let t=e.replace(m,"").replace(/^\/+|\/+$/g,"");if(!t||t==="index.html")return{type:"home",params:{}};const o=t.match(/^ricette\/([^/]+)\/([^/]+?)(?:\.html)?$/);if(o)return{type:"recipe",params:{category:o[1],slug:o[2]}};const i=t.match(/^ricette\/([^/]+)\/?$/);if(i)return{type:"category",params:{category:i[1]}};const r=t.match(/^cottura(?:\/([^/]+?))?(?:\.html)?$/);return r?{type:"cottura",params:{config:r[1]||null}}:{type:"nonTrovata",params:{percorso:e}}}let N=!0;function H(){const e=document.getElementById("contenuto"),t=e?.querySelector("h1")||e;t&&(t.hasAttribute("tabindex")||t.setAttribute("tabindex","-1"),t.focus({preventScroll:!0}));const o=document.title.replace(/\s*[—-]\s*(Il )?Ricettario( Lab)?\s*$/i,"").trim();we(o?`${o}, pagina caricata`:"Pagina caricata")}async function P(e,t=!0){const o=new URL(e,window.location.origin);t&&history.pushState(null,"",o.pathname+o.search);const i=ee(o.pathname),r=document.getElementById("app");if(!r)return;window.scrollTo(0,0);const a=N;if(N=!1,"startViewTransition"in document){const n=document.startViewTransition(async()=>{await G(i,r)});a||n.updateCallbackDone.then(H).catch(()=>{})}else await G(i,r),a||H()}async function G(e,t){const o=K[e.type];o?await o(t,e.params):z(t,{base:m}),A()}function A(){const e=document.querySelectorAll(".reveal:not(.visible)");if(e.length===0)return;const t=new IntersectionObserver(o=>{o.forEach(i=>{i.isIntersecting&&(i.target.classList.add("visible"),t.unobserve(i.target))})},{threshold:.1,rootMargin:"0px 0px -50px 0px"});e.forEach(o=>t.observe(o))}function Le(){const e=sessionStorage.getItem("spa-redirect");e&&(sessionStorage.removeItem("spa-redirect"),history.replaceState(null,"",e)),document.addEventListener("click",t=>{const o=t.target.closest("a[href]");if(!o)return;const i=o.getAttribute("href"),r=o.getAttribute("data-nav-section");if(r){if(ee(window.location.pathname).type!=="home"){t.preventDefault(),P(m).then(()=>{setTimeout(()=>{const s=document.getElementById(r);s&&s.scrollIntoView({behavior:"smooth"})},100)});return}return}if(!i||i.startsWith("http")||i.startsWith("#")||i.startsWith("mailto:")||i.startsWith("tel:")||o.target==="_blank")return;t.preventDefault();const a=new URL(i,window.location.href);P(a.href)}),window.addEventListener("popstate",()=>{P(window.location.href,!1)}),P(window.location.href,!1)}const te="ricettario_fatte";function D(){try{const e=localStorage.getItem(te);return e?new Set(JSON.parse(e)):new Set}catch{return new Set}}function Se(e){localStorage.setItem(te,JSON.stringify([...e]))}function Ae(e){return D().has(e)}function Me(e){const t=D(),o=!t.has(e);return o?t.add(e):t.delete(e),Se(t),o}function M(){const e=D();if(e.size===0)return;document.querySelectorAll(".recipe-card--compact, .category-card").forEach(o=>{const i=o.getAttribute("href")||"",r=new URL(i,location.origin).pathname.split("/").filter(Boolean).pop();if(r&&e.has(r)&&!o.querySelector(".made-badge")){const a=document.createElement("span");a.className="made-badge",a.textContent="✓",a.title="Ricetta già fatta!";const n=o.querySelector(".recipe-card--compact__image-wrapper, .category-card__image-wrapper");n&&n.appendChild(a)}})}function Ie(e){const t=document.getElementById("made-toggle");if(!t)return;const o=i=>{t.classList.toggle("made-toggle--active",i),t.innerHTML=i?'<span class="made-toggle__icon">✓</span> <span class="made-toggle__label">Fatta!</span>':'<span class="made-toggle__icon">○</span> <span class="made-toggle__label">Segna come fatta</span>',t.title=i?"Clicca per rimuovere":"Segna questa ricetta come fatta"};o(Ae(e)),t.addEventListener("click",i=>{i.preventDefault();const r=Me(e);o(r),t.classList.add("made-toggle--pop"),setTimeout(()=>t.classList.remove("made-toggle--pop"),400)})}const Te={"arrow-up-right":'<path d="M7 7h10v10"/><path d="M7 17 17 7"/>',"chevron-down":'<path d="m6 9 6 6 6-6"/>',"grid-3x3":'<rect width="18" height="18" x="3" y="3" rx="2"/><path d="M3 9h18"/><path d="M3 15h18"/><path d="M9 3v18"/><path d="M15 3v18"/>',list:'<path d="M3 5h.01"/><path d="M3 12h.01"/><path d="M3 19h.01"/><path d="M8 5h13"/><path d="M8 12h13"/><path d="M8 19h13"/>',microscope:'<path d="M6 18h8"/><path d="M3 22h18"/><path d="M14 22a7 7 0 1 0 0-14h-1"/><path d="M9 14h2"/><path d="M9 12a2 2 0 0 1-2-2V6h6v4a2 2 0 0 1-2 2Z"/><path d="M12 6V3a1 1 0 0 0-1-1H9a1 1 0 0 0-1 1v3"/>',moon:'<path d="M20.985 12.486a9 9 0 1 1-9.473-9.472c.405-.022.617.46.402.803a6 6 0 0 0 8.268 8.268c.344-.215.825-.004.803.401"/>',search:'<path d="m21 21-4.34-4.34"/><circle cx="11" cy="11" r="8"/>',sun:'<circle cx="12" cy="12" r="4"/><path d="M12 2v2"/><path d="M12 20v2"/><path d="m4.93 4.93 1.41 1.41"/><path d="m17.66 17.66 1.41 1.41"/><path d="M2 12h2"/><path d="M20 12h2"/><path d="m6.34 17.66-1.41 1.41"/><path d="m19.07 4.93-1.41 1.41"/>'},oe="http://www.w3.org/2000/svg",Pe={xmlns:oe,width:"24",height:"24",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor","stroke-width":"2","stroke-linecap":"round","stroke-linejoin":"round"};function je(e=document){for(const t of e.querySelectorAll("[data-lucide]")){const o=t.getAttribute("data-lucide"),i=Te[o];if(!i){console.warn(`[icons] icona "${o}" non disponibile: aggiungila a js/icons.js`);continue}const r=document.createElementNS(oe,"svg");for(const[a,n]of Object.entries(Pe))r.setAttribute(a,n);for(const a of t.attributes)a.name!=="data-lucide"&&r.setAttribute(a.name,a.value);r.setAttribute("class",`lucide lucide-${o}${t.className?" "+t.className:""}`),r.innerHTML=i,t.replaceWith(r)}}function V(e,t=20,o=""){return w(m,e,t,o)}const Re=J;function k(){je()}const ze=/\{([a-zA-Z_][a-zA-Z0-9_]*):(\d+(?:\.\d+)?)(!)?\}/,ie=()=>new RegExp(ze.source,"g");function F(e){return e===0?"0":e>=10?`${Math.round(e)}`:e>=1?`${Math.round(e*10)/10}`:`${Math.round(e*100)/100}`}function Be(e){return String(e||"").replace(ie(),(t,o,i,r)=>{const a=parseFloat(i);return`<span class="dose-inline" data-base="${a}" data-token-id="${o}"${r?' data-fixed="true"':""}>${F(a)}</span>`})}function Oe(e){return String(e||"").replace(ie(),(t,o,i)=>F(parseFloat(i)))}const De=["immagine esistente","caricata manualmente","provenienza non documentata"],Fe=["pexels","unsplash","pixabay","wikimedia","openverse","flickr"],U={"pexels license":"https://www.pexels.com/license/","unsplash license":"https://unsplash.com/license","pixabay license":"https://pixabay.com/service/license-summary/"};function qe(e){const t=String(e??"").trim().toLowerCase();if(!t)return null;if(U[t])return U[t];const o=t.replace(/^cc\s+/,"");if(/^cc0\b/.test(o)||o==="zero")return"https://creativecommons.org/publicdomain/zero/1.0/";if(/^(public domain|pdm|dominio pubblico)\b/.test(o))return"https://creativecommons.org/publicdomain/mark/1.0/";const i=o.match(/^(by(?:-nc)?(?:-sa|-nd)?)\s+(\d\.\d)$/);return i?`https://creativecommons.org/licenses/${i[1]}/${i[2]}/`:null}function Ne(e){const t=String(e??"").trim();if(!/^https:\/\//i.test(t))return null;const o=t.match(/^https:\/\/upload\.wikimedia\.org\/wikipedia\/[a-z-]+\/(?:thumb\/)?[0-9a-f]\/[0-9a-f]{2}\/([^/?#]+)/i);if(o)return`https://commons.wikimedia.org/wiki/File:${o[1]}`;const i=t.match(/^https:\/\/images\.pexels\.com\/photos\/(\d+)\//i);return i?`https://www.pexels.com/photo/${i[1]}/`:/^https:\/\/(commons\.wikimedia\.org\/wiki\/|www\.pexels\.com\/photo\/|unsplash\.com\/photos\/|pixabay\.com\/[a-z-]+\/|openverse\.org\/image\/|www\.flickr\.com\/photos\/)/i.test(t)?t:null}function He(e,t){const o=String(e??"").trim();if(!o)return null;const i=o.replace(/^📷\s*/,"").replace(/^Foto:\s*/i,"").trim();if(!i||De.includes(i.toLowerCase()))return null;const r=i.split(/\s+[—–]\s+/),a=r[0].trim();if(!a)return null;let n=null,s=null;if(r.length>1){const l=r.slice(1).join(" — ").trim(),d=l.match(/^(.*?)\s+via\s+(.+)$/i);d?(n=d[1].trim()||null,s=d[2].trim()):Fe.includes(l.toLowerCase())?s=l:n=l||null}return{autore:a,licenza:n,fonte:s,urlLicenza:qe(n),urlFonte:Ne(t)}}function Ge(e,t){const o=He(e,t);if(!o)return"";const i=(n,s,l)=>s?`<a href="${c(s)}" target="_blank" rel="${l}">${c(n)}</a>`:c(n),r=!!(o.licenza&&!o.urlLicenza&&o.urlFonte);let a=`Foto: ${c(o.autore)}`;return o.licenza&&(a+=r?` — ${i(o.licenza,o.urlFonte,"noopener nofollow")}`:` — ${i(o.licenza,o.urlLicenza,"license noopener nofollow")}`),o.fonte?a+=` via ${i(o.fonte,r?null:o.urlFonte,"noopener nofollow")}`:o.urlFonte&&!r&&(a+=` — ${i("fonte",o.urlFonte,"noopener nofollow")}`),a}const Ve=["n/a","na","nessuna","nessuno","none","null","0","-","—"];function x(e){if(e==null)return!1;const t=String(e).trim();return t!==""&&!Ve.includes(t.toLowerCase())}function re(e){const t=e.replace(/\.(jpg|jpeg|png|webp)$/i,"");return{avif:`${t}.avif`,webp:`${t}.webp`}}function ae(e,t,o="",i="lazy"){if(!e)return"";const{avif:r,webp:a}=re(e),n=o?` class="${h(o)}"`:"",s=i?` loading="${h(i)}"`:"";return`<picture>
  <source srcset="${h(r)}" type="image/avif">
  <source srcset="${h(a)}" type="image/webp">
  <img src="${h(a)}" alt="${h(t)}"${n}${s}>
</picture>`}function Ue(e,t){if(!e)return"";const{avif:o,webp:i}=re(e);return`<picture class="recipe-hero__picture">
  <source srcset="${h(o)}" type="image/avif">
  <source srcset="${h(i)}" type="image/webp">
  <img src="${h(i)}" alt="${h(t)}" class="recipe-hero__img">
</picture>`}function We(e){return e.replace(/class="([^"]*)"/g,(t,o)=>`class="${o.split(/\s+/).filter(r=>r&&r!=="reveal"&&!/^reveal-delay-\d$/.test(r)).join(" ")}"`)}function Xe(e,{base:t,categoryDir:o,interattivo:i=!0}){const r={base:t,interattivo:i,emoji:(d,g)=>w(t,d,g),testoStep:d=>i?Be(c(d)):c(Oe(d))},a=Ce(t,e.category,22),n=e.image?`${t}${String(e.image).replace(/^\//,"")}`:`${t}images/ricette/${o}/${e.slug}.webp`,s=Ge(e.imageAttribution,e._originalImageUrl),l=`
    <!-- ═══════════ RECIPE HERO ═══════════ -->
    ...
    <div class="recipe-hero">
      ...
      <div class="container">
        <nav class="breadcrumb reveal">
          ...
          <span class="breadcrumb__separator">›</span>
          <a href="${h(t)}ricette/${h(o)}/" data-link>${c(e.category)}</a>
          <span class="breadcrumb__separator">›</span>
          <span>${c(e.title)}</span>
        </nav>
  ...
  `;return i?l:We(l)}function W(e){return`<tr${e.excludeFromTotal?' data-exclude-total="true"':""}>
  ...
  </tr>`}function Ye(e){const o=(e.ingredientGroups?.length?e.ingredientGroups.flatMap(i=>i.items||[]):e.ingredients||[]).filter(i=>i&&!i.excludeFromTotal&&typeof i.grams=="number").reduce((i,r)=>i+r.grams,0);return o<=0?"":o>=1e3?`~${(o/1e3).toFixed(1)}kg`:`${Math.round(o)}g`}function Qe(e,t){const o=e.ingredientGroups?.length>0,i=e.ingredients?.length>0;if(!o&&!i)return"";let r;o?r=e.ingredientGroups.map(n=>{if(!n.items?.length)return"";const s=`<tr class="ingredient-section-header"><th colspan="2" scope="colgroup">${c(n.group||"Ingredienti")}</th></tr>`,l=n.items.map(W).join("");return s+l}).join(""):r=e.ingredients.map(W).join("");const a=t.interattivo?`
    ...
    <div class="recipe-panel reveal">
      ...
      <table class="ingredients-table" id="ingredients-table" aria-label="Ingredienti e quantità">
        ...
        <tr class="ingredient-total-row" id="ingredient-total-row">
          ...
          <td class="ingredient-qty" id="ingredient-total-qty">${t.interattivo?"":Ye(e)}</td>
        </tr>
      </table>
    </div>`}function Ze(e,t){const o=e.suspensions.map(i=>`
    <tr>
  ...
  `).join("");return`
    ...
    </div>`}function Je(e,t){const o=e.steps;return o?.length?`
    ...
    </div>`:""}function Ke(e,t){const o=e.stepsCondiment;return o?.length?`
    ...
    </div>`:""}function et(e,t){if(!e.sensoryProfile||!e.sensoryProfile.axes||e.sensoryProfile.axes.length===0)return"";const o=e.sensoryProfile.axes.reduce((n,s)=>s.value>n.value?s:n,e.sensoryProfile.axes[0]),i=e.sensoryProfile.summary?`
  ...
  `:"";let r="";if(e.nutrition&&e.nutrition.macros){const n=Number(e.nutrition.macros.carbs)||0,s=Number(e.nutrition.macros.protein)||0,l=Number(e.nutrition.macros.fat)||0,d=n+s+l,g=d>0?n/d*100:0,f=d>0?s/d*100:0,b=d>0?l/d*100:0,_=`
        <div class="nutrition-content">
          ...
          <div class="nutrition-bar">
            ...
            <div class="nutrition-bar__segment nutrition-bar__segment--prot" style="width: ${f}%;" title="Proteine"></div>
...
${_}`}const a=e.sensoryProfile.axes.map(n=>`<tr><th scope="row">${c(n.label)}</th><td>${c(n.value)} su 10</td></tr>`).join("");return t.interattivo?`
  ...
  `:`
    <div class="recipe-panel sensory-panel recipe-panel--spaced">
      ...
      ${i}
      ${r}
    </div>`}function tt(e,t){return e.flourTable?.length?`
    ...
    </div>`:""}function ot(e,t){return e.alert?`
    ...
    </div>`:""}function it(e,t){if(!e.baking)return"";const o=e.baking;return`
    <div class="recipe-panel reveal recipe-panel--spaced">
      <h2 class="recipe-panel__title">
    ...
    </div>`}function rt(e,t){return e.proTips?.length?`
    <div class="recipe-panel reveal recipe-panel--spaced">
      <h2 class="recipe-panel__title">
    ...
    </div>`:""}function at(e,t){return e.storage?.length?`
    <div class="recipe-panel reveal recipe-panel--spaced">
      <h2 class="recipe-panel__title">
    ...
    </div>`:""}function nt(e,t){return e.glossary?.length?`
    <div class="recipe-panel reveal recipe-panel--spaced">
      <h2 class="recipe-panel__title">
    ...
    </div>`:""}async function st(e,{category:t,slug:o}){e.innerHTML=`
    <div class="recipe-loading">
      <div class="recipe-loading__spinner"></div>
      <p>Caricamento ricetta...</p>
    </div>`;let i=!1;try{const r=`${m}ricette/${t}/${o}.json`,a=await fetch(r);if(i=a.status===404,!a.ok)throw new Error(`HTTP ${a.status} su ${r}`);const n=await a.json();document.title=`${n.title} — Ricettario Lab`;const s=document.querySelector('meta[name="description"]');s&&s.setAttribute("content",n.description||""),e.innerHTML=Xe(n,{base:m,categoryDir:t,interattivo:!0}),ct(n),Ie(n.slug),dt(n),k()}catch(r){console.error(`Ricetta ${t}/${o} non caricata:`,r);const a=Z[t];z(e,{base:m,titolo:i?"Ricetta non trovata":"Ricetta non caricata",dettaglio:i?`Non c'è nessuna ricetta all'indirizzo «${t}/${o}». Può essere un refuso, o una ricetta che è stata spostata.`:"Il caricamento non è riuscito. Controlla la connessione e riprova.",uscite:a&&[{href:`${m}ricette/${t}/`,testo:`Vedi le ricette di ${a.name}`},{href:m,testo:"Torna alla home"}]})}}function ct(e){const t=document.getElementById("dose-badge"),o=document.getElementById("dose-decrease"),i=document.getElementById("dose-increase");if(!t||!o||!i)return;const r=.25,a=.25;let n=1;const s=[],l=e.ingredientGroups?.length?e.ingredientGroups.flatMap(p=>p.items||[]):e.ingredients||[],d=["ingredients-table","suspensions-table"],g=[l,e.suspensions||[]];d.forEach((p,y)=>{const $=document.getElementById(p);if(!$)return;const E=$.querySelectorAll("tr:not(.ingredient-section-header)"),v=g[y];let S=0;for(const I of v){if(I.grams==null)continue;if(S>=E.length)break;const T=E[S]?.querySelector(".ingredient-qty");T&&s.push({baseGrams:I.grams,cell:T}),S++}});const f=p=>p===0?"0g":p>=10?`${Math.round(p)}g`:p>=1?`${Math.round(p*10)/10}g`:`${Math.round(p*100)/100}g`,b=p=>{if(Number.isInteger(p))return`×${p}`;const y=Math.round(p*10)/10;return Math.abs(p-y)<.001?`×${y.toFixed(1)}`:`×${p.toFixed(2)}`},_=()=>{t.textContent=b(n),t.classList.toggle("dose-calculator__display--modified",n!==1),o.disabled=n<=a,s.forEach(({baseGrams:p,cell:y})=>{const $=y.getAttribute("data-base"),E=$!==null?parseFloat($):p;y.textContent=f(E*n),y.getAnimations().forEach(v=>v.cancel()),y.classList.remove("dose-updated"),requestAnimationFrame(()=>y.classList.add("dose-updated"))}),document.querySelectorAll(".dose-inline:not([data-fixed])").forEach(p=>{const y=parseFloat(p.getAttribute("data-base"));isNaN(y)||(p.textContent=F(y*n),p.getAnimations().forEach($=>$.cancel()),p.classList.remove("dose-updated"),requestAnimationFrame(()=>p.classList.add("dose-updated")))}),lt()};o.addEventListener("click",()=>{const p=Math.round((n-r)*100)/100;p>=a&&(n=p,_())}),i.addEventListener("click",()=>{n=Math.round((n+r)*100)/100,_()}),_()}function lt(){const e=document.getElementById("ingredient-total-qty");if(!e)return;let t=0;const o=document.getElementById("ingredients-table");if(!o)return;o.querySelectorAll("tr:not(.ingredient-section-header):not(.ingredient-total-row):not([data-exclude-total]) .ingredient-qty").forEach(r=>{const a=r.textContent.trim(),n=parseFloat(a);isNaN(n)||(t+=n)});const i=t>=1e3?`~${(t/1e3).toFixed(1)}kg`:`${Math.round(t)}g`;e.textContent=i,e.classList.remove("dose-updated"),e.offsetWidth,e.classList.add("dose-updated")}let B=null;function dt(e){const t=document.getElementById("sensory-header");if(!t)return;const o=document.getElementById("sensory-chart-container");if(!o)return;const i=()=>t.querySelector(".sensory-chevron"),r=e.sensoryProfile?.axes;if(!r?.length)return;const a={labels:r.map(s=>s.label),values:r.map(s=>s.value)};let n=null;t.addEventListener("click",async()=>{const s=o.style.display==="none"||!o.style.display;if(t.setAttribute("aria-expanded",String(s)),s){if(o.style.display="block",i()?.style.setProperty("transform","rotate(180deg)"),!B)try{const{Chart:v,RadarController:S,RadialLinearScale:I,PointElement:T,LineElement:de,Filler:pe,Tooltip:ue}=await O(async()=>{const{Chart:ge,RadarController:me,RadialLinearScale:he,PointElement:fe,LineElement:_e,Filler:ye,Tooltip:be}=await import("./chart-Cns13J0s.js");return{Chart:ge,RadarController:me,RadialLinearScale:he,PointElement:fe,LineElement:_e,Filler:ye,Tooltip:be}},[]);v.register(S,I,T,de,pe,ue),B=v}catch(v){console.error("Errore caricamento Chart.js:",v);return}n&&(n.destroy(),n=null);const l=document.getElementById("sensoryChart")?.getContext("2d");if(!l)return;const{labels:d,values:g}=a,f=window.innerWidth<600,b=d.map(v=>f&&v.includes(" ")?v.split(" "):v),_=document.documentElement.getAttribute("data-theme")==="dark",p=_?"rgba(212, 165, 116, 0.8)":"rgba(184, 129, 58, 0.8)",y=_?"rgba(212, 165, 116, 0.2)":"rgba(184, 129, 58, 0.2)",$=_?"rgba(255, 255, 255, 0.1)":"rgba(0, 0, 0, 0.1)",E=_?"#94a3b8":"#64748b";n=new B(l,{type:"radar",data:{labels:b,datasets:[{label:"Valore",data:g,backgroundColor:y,borderColor:p,pointBackgroundColor:p,pointBorderColor:"#fff",pointHoverBackgroundColor:"#fff",pointHoverBorderColor:p,borderWidth:2}]},options:{responsive:!0,maintainAspectRatio:!0,layout:{padding:f?10:20},scales:{r:{min:0,max:10,angleLines:{color:$},grid:{color:$},pointLabels:{color:E,font:{family:"Inter",size:f?10:12,weight:"500"}},ticks:{display:!1,stepSize:2}}},plugins:{legend:{display:!1},tooltip:{backgroundColor:_?"#1e293b":"#fff",titleColor:_?"#f8fafc":"#0f172a",bodyColor:_?"#cbd5e1":"#475569",borderColor:_?"#334155":"#e2e8f0",borderWidth:1,padding:10,displayColors:!1,callbacks:{label:v=>v.formattedValue+" / 10"}}}}})}else o.style.display="none",i()?.style.setProperty("transform","rotate(0deg)")})}function pt(){return`
  ...
  `}function gt(){if(sessionStorage.getItem("intro-shown"))return;if(window.matchMedia("(prefers-reduced-motion: reduce)").matches){sessionStorage.setItem("intro-shown","1");return}O(()=>Promise.resolve({}),__vite__mapDeps([0]));const e=()=>{document.body.insertAdjacentHTML("afterbegin",ut()),mt(),sessionStorage.setItem("intro-shown","1")};document.body?e():document.addEventListener("DOMContentLoaded",e,{once:!0})}function mt(){const e=document.getElementById("logo-intro"),t=document.getElementById("logo-intro-logo");if(!e)return;document.documentElement.style.overflow="hidden";const o=setTimeout(()=>{t&&t.classList.add("glowing")},1700);e.addEventListener("animationend",i=>{i.animationName==="introOverlayOut"&&(document.documentElement.style.overflow="",e.classList.add("logo-intro--done"),requestAnimationFrame(()=>e.remove()),clearTimeout(o))}),setTimeout(()=>{document.getElementById("logo-intro")&&(document.documentElement.style.overflow="",e.remove())},5e3)}function ne(e,{base:t}){const o=`${t}ricette/${e.categoryDir}/${e.slug}/`;return`
      <a href="${h(o)}" class="category-card" data-link
         data-title="${h((e.title||"").toLowerCase())}"
         data-hydration="${parseInt(e.hydration)||0}">
        <div class="category-card__image-wrapper">
          ${e.image?ae(`${t}${e.image}`,"","category-card__image","lazy"):""}
      ...
      </a>`}function ht(e){return Array.from({length:e},()=>`
    <div class="category-card category-card--skeleton">
      ...
      <div class="category-card__body">
    ...
    </div>`).join("")}function ft(e,t,{base:o,interattivo:i=!0,viewMode:r="grid"}){const a="⏳ Caricamento...",n=i?`
        <div class="category-toolbar" id="category-toolbar">
          <div class="category-toolbar__search">
            ...
            <input type="text" class="category-toolbar__search-input" id="category-search"
              placeholder="Cerca tra le ricette di ${h(e.name.toLowerCase())}...">
          </div>
        ...
        </div>`:"",s=i?ht(6):t.map(l=>ne(l,{base:o})).join("");return`
  ...
  `}function _t(e,{base:t}){const o=`${t}ricette/${e.categoryDir}/${e.slug}/`;return`
          <a href="${h(o)}" class="recipe-card--compact" data-link data-title="${h((e.title||"").toLowerCase())}" data-category="${h(e.category)}">
            <div class="recipe-card--compact__image-wrapper">
              ${e.image?ae(`${t}${e.image}`,"","recipe-card--compact__image","lazy"):""}
            </div>
          ...
          </a>`}function yt(e,t,o,i,{base:r}){return`
    <div class="category-row__header">
      ...
      <a href="${h(`${r}ricette/${o}/`)}" class="category-row__link" data-link>Vedi tutte</a>
    </div>
    <div class="category-row__carousel-wrapper">
      <div class="category-row__carousel">
        ${i.map(a=>_t(a,{base:r})).join("")}
      </div>
    </div>
  `}const se="?v=51e5f5ba";gt();document.addEventListener("DOMContentLoaded",()=>{bt(),vt(),$t();const e=document.getElementById("current-year");e&&(e.textContent=new Date().getFullYear()),k(),xt(),ke({home:Ct,recipe:st,category:Lt,cottura:async(t,o)=>{const{renderCottura:i}=await O(async()=>{const{renderCottura:r}=await import("./pagina-BK0uCMKY.js");return{renderCottura:r}},__vite__mapDeps([1,2]));return i(t,o)},nonTrovata:(t,{percorso:o}={})=>z(t,{base:m,dettaglio:o?`L'indirizzo «${o}» non corrisponde a nessuna pagina di questo sito.`:""})}),Le()});function bt(){const e=document.getElementById("navbar");if(!e)return;const t=()=>e.classList.toggle("scrolled",window.scrollY>50);window.addEventListener("scroll",t,{passive:!0}),t()}function vt(){const e=document.getElementById("theme-toggle");e&&(e.addEventListener("click",()=>{const o=document.documentElement.getAttribute("data-theme")==="dark"?"light":"dark";e.classList.add("theme-toggle--switching"),setTimeout(()=>e.classList.remove("theme-toggle--switching"),400),document.documentElement.setAttribute("data-theme",o),window.applicaColoreBarra?.(o),localStorage.setItem("theme",o)}),window.matchMedia("(prefers-color-scheme: dark)").addEventListener("change",t=>{if(!localStorage.getItem("theme")){const o=t.matches?"dark":"light";document.documentElement.setAttribute("data-theme",o),window.applicaColoreBarra?.(o)}}))}function $t(){const e=document.getElementById("hamburger"),t=document.getElementById("nav-links");!e||!t||(e.addEventListener("click",()=>{e.classList.toggle("open"),t.classList.toggle("open")}),t.querySelectorAll("a").forEach(o=>{o.addEventListener("click",()=>{e.classList.remove("open"),t.classList.remove("open")})}),document.addEventListener("click",o=>{!e.contains(o.target)&&!t.contains(o.target)&&(e.classList.remove("open"),t.classList.remove("open"))}))}let C=null;function wt(e){const t=new URL(m,window.location.origin),o=i=>!i||/^([a-z]+:|\/\/|\/|#)/i.test(i)?i:new URL(i,t).pathname;e.querySelectorAll("[src], [href], [srcset]").forEach(i=>{["src","href"].forEach(a=>{const n=i.getAttribute(a);n&&i.setAttribute(a,o(n))});const r=i.getAttribute("srcset");r&&i.setAttribute("srcset",r.split(",").map(a=>{const[n,...s]=a.trim().split(/\s+/);return[o(n),...s].join(" ")}).join(", "))})}function ce(e,t,o){const i=e.cloneNode(!0);return wt(i),{html:i.innerHTML,title:t,description:o}}function xt(){const e=document.getElementById("app");e?.querySelector("#ricette")&&(C=ce(e,document.title,document.querySelector('meta[name="description"]')?.getAttribute("content")||""))}async function Et(){if(C)return C;const e=await fetch(m),t=new DOMParser().parseFromString(await e.text(),"text/html"),o=t.getElementById("app");if(!o)throw new Error("index.html non contiene #app");return C=ce(o,t.title,t.querySelector('meta[name="description"]')?.getAttribute("content")||""),C}async function Ct(e){if(!e.querySelector("#ricette"))try{const o=await Et();e.innerHTML=o.html}catch(o){console.error("Impossibile ricostruire la homepage:",o),window.location.assign(m);return}const t=C;if(t){document.title=t.title;const o=document.querySelector('meta[name="description"]');o&&o.setAttribute("content",t.description)}k(),At(),A()}const L=12,kt=Z;let u={allRecipes:[],filteredRecipes:[],displayedCount:L,viewMode:"grid",sortType:"az",searchQuery:"",categoryDir:""};async function Lt(e,{category:t}){const o=kt[t];if(!o){z(e,{base:m,titolo:"Categoria non trovata",dettaglio:`La categoria «${t}» non esiste (o non esiste più).`});return}document.title=`${o.title} — Il Ricettario`;const i=document.querySelector('meta[name="description"]');i&&i.setAttribute("content",o.desc),u={allRecipes:[],filteredRecipes:[],displayedCount:L,viewMode:localStorage.getItem("catViewMode")||"grid",sortType:"az",searchQuery:"",categoryDir:t},e.innerHTML=ft(o,null,{base:m,interattivo:!0,viewMode:u.viewMode}),k();try{const a=await(await fetch(`${m}recipes.json${se}`)).json();u.allRecipes=a.recipes.filter(l=>l.categoryDir===t||l.category===o.name),u.allRecipes.sort((l,d)=>(l.title||"").localeCompare(d.title||"","it")),u.filteredRecipes=[...u.allRecipes];const n=u.allRecipes.find(l=>l.image);if(n){const l=document.getElementById("category-hero");l&&(l.style.backgroundImage=`url('${m}${n.image}')`)}const s=document.getElementById("recipe-count");s&&(s.innerHTML=`${V("bullseye",16)} ${u.allRecipes.length} ricett${u.allRecipes.length===1?"a":"e"}`),j(),St(e),A(),M()}catch(r){console.error("Errore caricamento categoria:",r);const a=document.getElementById("category-grid");a&&(a.innerHTML=`<div class="category-empty"><div class="category-empty__icon">${V("prohibited",32)}</div><p>Errore nel caricamento delle ricette.</p></div>`)}}function St(e){const t=document.getElementById("category-search");let o;t&&t.addEventListener("input",()=>{clearTimeout(o),o=setTimeout(()=>{u.searchQuery=t.value.toLowerCase().trim(),u.displayedCount=L,X(),j()},150)});const i=e.querySelectorAll(".category-toolbar__sort-btn");i.forEach(a=>{a.addEventListener("click",()=>{i.forEach(n=>n.classList.remove("active")),a.classList.add("active"),u.sortType=a.dataset.sort,u.displayedCount=L,X(),j()})});const r=e.querySelectorAll(".view-toggle-btn");r.forEach(a=>{a.addEventListener("click",()=>{r.forEach(s=>s.classList.remove("active")),a.classList.add("active"),u.viewMode=a.dataset.view,localStorage.setItem("catViewMode",u.viewMode);const n=document.getElementById("category-grid");n&&n.classList.toggle("category-grid--list",u.viewMode==="list")})})}function X(){let e=[...u.allRecipes];u.searchQuery&&(e=e.filter(t=>{const o=(t.title||"").toLowerCase(),i=(t.description||"").toLowerCase();return o.includes(u.searchQuery)||i.includes(u.searchQuery)})),u.sortType==="az"?e.sort((t,o)=>(t.title||"").localeCompare(o.title||"","it")):u.sortType==="hydration"&&e.sort((t,o)=>(parseInt(o.hydration)||0)-(parseInt(t.hydration)||0)),u.filteredRecipes=e}function j(){const e=document.getElementById("category-grid"),t=document.getElementById("load-more-container");if(!e)return;const{filteredRecipes:o,displayedCount:i}=u,r=o.slice(0,i),a=o.length,n=document.getElementById("results-counter");if(n&&(u.searchQuery?n.innerHTML=`<strong>${a}</strong> risultat${a===1?"o":"i"}`:n.innerHTML=`<strong>${Math.min(i,a)}</strong> di <strong>${a}</strong>`),a===0){e.innerHTML=`
      <div class="category-empty" style="grid-column: 1 / -1">
      ...
      </div>`,t&&(t.innerHTML=""),k();return}if(e.innerHTML=r.map(s=>ne(s,{base:m})).join(""),t)if(i<a){const s=a-i,l=Math.round(i/a*100);t.innerHTML=`
        ...
        </div>`,document.getElementById("load-more-btn")?.addEventListener("click",()=>{u.displayedCount+=L,j(),setTimeout(()=>{const g=e.querySelectorAll(".category-card")[i];g&&g.scrollIntoView({behavior:"smooth",block:"center"})},100),M()})}else t.innerHTML="";k(),M()}function Y(e,t,o,i,r){const a=document.createElement("div");a.className="category-row reveal",a.dataset.category=t,a.innerHTML=yt(t,o,i,r,{base:m}),e.appendChild(a),le(a)}function le(e){if(e.dataset.attivo)return;e.dataset.attivo="1";const t=e.querySelector(".category-row__carousel"),o=e.querySelector(".category-row__carousel-wrapper");if(!t||!o)return;const i=(l,d,g)=>{const f=document.createElement("button");return f.className=`carousel-arrow ${l}`,f.setAttribute("aria-label",d),f.textContent=g,f},r=i("carousel-arrow--prev","Precedente","‹"),a=i("carousel-arrow--next","Successivo","›");o.insertBefore(r,t),o.appendChild(a);const n=276,s=()=>{const{scrollLeft:l,scrollWidth:d,clientWidth:g}=t;o.classList.toggle("has-scroll-left",l>10),o.classList.toggle("has-scroll-right",l<d-g-10),r.disabled=l<=10,a.disabled=l>=d-g-10};t.addEventListener("scroll",s,{passive:!0}),s(),new ResizeObserver(s).observe(t),r.addEventListener("click",()=>t.scrollBy({left:-n*3,behavior:"smooth"})),a.addEventListener("click",()=>t.scrollBy({left:n*3,behavior:"smooth"}))}function At(){const e=document.getElementById("recipe-carousels");if(!e)return;const t=e.querySelectorAll(".category-row");if(t.length){t.forEach(le),A(),Q(),M();return}const o=xe.map(i=>{const r=R[i];return{key:r.name,emoji:r.emoji,dir:r.dir}});fetch(`${m}recipes.json${se}`).then(i=>i.json()).then(i=>{e.innerHTML="";const r={};i.recipes.forEach(n=>{r[n.category]||(r[n.category]=[]),r[n.category].push(n)}),o.forEach(n=>{const s=r[n.key];!s||s.length===0||Y(e,n.key,n.emoji,n.dir,s)});const a=new Set(o.map(n=>n.key));Object.keys(r).forEach(n=>{if(a.has(n))return;const s=r[n];if(!s||s.length===0)return;const l=n.toLowerCase(),d=Re[n]||"fork-and-knife";Y(e,n,d,l,s)}),A(),Q(),M()}).catch(i=>{console.error("Errore caricamento recipes.json:",i),e.innerHTML='<p style="text-align:center; color: var(--color-text-muted);">Errore nel caricamento delle ricette.</p>'})}function Q(){const e=document.getElementById("search-input");e&&(e.addEventListener("input",()=>{const t=e.value.toLowerCase().trim(),o=document.querySelectorAll(".recipe-card--compact"),i=document.querySelectorAll(".category-row");o.forEach(r=>{const a=r.dataset.title||r.textContent.toLowerCase();r.classList.toggle("hidden",!!(t&&!a.includes(t)))}),i.forEach(r=>{const a=r.querySelectorAll(".recipe-card--compact:not(.hidden)");r.classList.toggle("hidden",a.length===0)})}),document.addEventListener("keydown",t=>{t.key==="/"&&document.activeElement!==e&&(t.preventDefault(),e.focus(),e.scrollIntoView({behavior:"smooth",block:"center"})),t.key==="Escape"&&document.activeElement===e&&(e.value="",e.dispatchEvent(new Event("input")),e.blur())}))}export{m as B,we as a,c as e,z as m,P as n};
