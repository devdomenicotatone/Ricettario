...
(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const a of document.querySelectorAll('link[rel="modulepreload"]'))i(a);new MutationObserver(a=>{for(const r of a)if(r.type==="childList")for(const n of r.addedNodes)n.tagName==="LINK"&&n.rel==="modulepreload"&&i(n)}).observe(document,{childList:!0,subtree:!0});function o(a){const r={};return a.integrity&&(r.integrity=a.integrity),a.referrerPolicy&&(r.referrerPolicy=a.referrerPolicy),a.crossOrigin==="use-credentials"?r.credentials="include":a.crossOrigin==="anonymous"?r.credentials="omit":r.credentials="same-origin",r}function i(a){if(a.ep)return;a.ep=!0;const r=o(a);fetch(a.href,r)}})();const pe="modulepreload",ue=function(e){return"/Ricettario/"+e},O={},D=function(t,o,i){let a=Promise.resolve();if(o&&o.length>0){let n=function(g){return Promise.all(g.map(f=>Promise.resolve(f).then(y=>({status:"fulfilled",value:y}),y=>({status:"rejected",reason:y}))))};document.getElementsByTagName("link");const s=document.querySelector("meta[property=csp-nonce]"),l=s?.nonce||s?.getAttribute("nonce");a=n(o.map(g=>{if(g=ue(g),g in O)return;O[g]=!0;const f=g.endsWith(".css"),y=f?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${g}"]${y}`))return;const d=document.createElement("link");if(d.rel=f?"stylesheet":pe,f||(d.as="script"),d.crossOrigin="",d.href=g,l&&d.setAttribute("nonce",l),document.head.appendChild(d),f)return new Promise((w,p)=>{d.addEventListener("load",w),d.addEventListener("error",()=>p(new Error(`Unable to preload CSS for ${g}`)))})}))}function r(n){const s=new Event("vite:preloadError",{cancelable:!0});if(s.payload=n,window.dispatchEvent(s),!s.defaultPrevented)throw n}return a.then(n=>{for(const s of n||[])s.status==="rejected"&&r(s.reason);return t().catch(r)})},h="/Ricettario/";let V={};function ge(e){V=e}function U(e){let t=e.replace(h,"").replace(/^\/+|\/+$/g,"");if(!t||t==="index.html")return{type:"home",params:{}};const o=t.match(/^ricette\/([^/]+)\/([^/]+?)(?:\.html)?$/);if(o)return{type:"recipe",params:{category:o[1],slug:o[2]}};const i=t.match(/^ricette\/([^/]+)\/?$/);if(i)return{type:"category",params:{category:i[1]}};const a=t.match(/^cottura(?:\/([^/]+?))?(?:\.html)?$/);return a?{type:"cottura",params:{config:a[1]||null}}:{type:"home",params:{}}}async function I(e,t=!0){const o=new URL(e,window.location.origin);t&&history.pushState(null,"",o.pathname+o.search);const i=U(o.pathname),a=document.getElementById("app");a&&(window.scrollTo(0,0),"startViewTransition"in document?document.startViewTransition(async()=>{await F(i,a)}):await F(i,a))}async function F(e,t){const o=V[e.type];o?await o(t,e.params):t.innerHTML=`<div class="container" style="padding: 80px 0; text-align: center;">
  ...
  <img src="${_(i)}" alt="${_(t)}" class="recipe-hero__img">
    ...
    <div class="recipe-loading">
      ...
      <div class="container" style="padding: 120px 0; text-align: center;">
        ...
        <a href="${h}" data-link class="btn-back">${u("fire",16)} Torna alla Home</a>
      </div>`}}function ze(e,t){const o=Le(e.category,22),i=e.image?`${h}${e.image.replace(/^\//,"")}`:`${h}images/ricette/${t}/${e.slug}.webp`,a=Re(e.imageAttribution,e._originalImageUrl);return`
    <!-- ═══════════ RECIPE HERO ═══════════ -->
    ...
    <div class="recipe-hero">
      ...
      <div class="container">
        <nav class="breadcrumb reveal">
          ...
          <span class="breadcrumb__separator">›</span>
          <a href="${_(h)}ricette/${_(t)}/" data-link>${c(e.category)}</a>
          <span class="breadcrumb__separator">›</span>
          <span>${c(e.title)}</span>
        </nav>
  ...
  `}function q(e){return`<tr${e.excludeFromTotal?' data-exclude-total="true"':""}>
    ...
    <tr>
      <td>${c(o.name)} ${o.note?`<span class="ingredient-note">${c(o.note)}</span>`:""}</td>
  ...
  `:"";let i="";if(e.nutrition&&e.nutrition.macros){const n=Number(e.nutrition.macros.carbs)||0,s=Number(e.nutrition.macros.protein)||0,l=Number(e.nutrition.macros.fat)||0,g=n+s+l,f=g>0?n/g*100:0,y=g>0?s/g*100:0,d=g>0?l/g*100:0;i=`
      <details class="nutrition-toggle">
        ...
        <div class="nutrition-content">
          ...
          <div class="nutrition-bar">
            ...
            <div class="nutrition-bar__segment nutrition-bar__segment--prot" style="width: ${y}%;" title="Proteine"></div>
            <div class="nutrition-bar__segment nutrition-bar__segment--fat" style="width: ${d}%;" title="Grassi"></div>
          </div>
  ...
  `}function qe(e){return e.flourTable?.length?`
    ...
    </div>`:""}function Xe(e){const t=document.getElementById("dose-badge"),o=document.getElementById("dose-decrease"),i=document.getElementById("dose-increase");if(!t||!o||!i)return;const a=.25,r=.25;let n=1;const s=[],l=e.ingredientGroups?.length?e.ingredientGroups.flatMap(p=>p.items||[]):e.ingredients||[],g=["ingredients-table","suspensions-table"],f=[l,e.suspensions||[]];g.forEach((p,b)=>{const $=document.getElementById(p);if(!$)return;const v=$.querySelectorAll("tr:not(.ingredient-section-header)"),L=f[b];let S=0;for(const A of L){if(A.grams==null)continue;if(S>=v.length)break;const M=v[S]?.querySelector(".ingredient-qty");M&&s.push({baseGrams:A.grams,cell:M}),S++}});const y=p=>p===0?"0g":p>=10?`${Math.round(p)}g`:p>=1?`${Math.round(p*10)/10}g`:`${Math.round(p*100)/100}g`,d=p=>{if(Number.isInteger(p))return`×${p}`;const b=Math.round(p*10)/10;return Math.abs(p-b)<.001?`×${b.toFixed(1)}`:`×${p.toFixed(2)}`},w=()=>{t.textContent=d(n),t.classList.toggle("dose-calculator__display--modified",n!==1),o.disabled=n<=r,s.forEach(({baseGrams:p,cell:b})=>{const $=b.getAttribute("data-base"),v=$!==null?parseFloat($):p;b.textContent=y(v*n),b.getAnimations().forEach(L=>L.cancel()),b.classList.remove("dose-updated"),requestAnimationFrame(()=>b.classList.add("dose-updated"))}),document.querySelectorAll(".dose-inline:not([data-fixed])").forEach(p=>{const b=parseFloat(p.getAttribute("data-base"));isNaN(b)||(p.textContent=K(b*n),p.getAnimations().forEach($=>$.cancel()),p.classList.remove("dose-updated"),requestAnimationFrame(()=>p.classList.add("dose-updated")))}),Ye()};o.addEventListener("click",()=>{const p=Math.round((n-a)*100)/100;p>=r&&(n=p,w())}),i.addEventListener("click",()=>{n=Math.round((n+a)*100)/100,w()}),w()}function Ye(){const e=document.getElementById("ingredient-total-qty");if(!e)return;let t=0;const o=document.getElementById("ingredients-table");if(!o)return;o.querySelectorAll("tr:not(.ingredient-section-header):not(.ingredient-total-row):not([data-exclude-total]) .ingredient-qty").forEach(a=>{const r=a.textContent.trim(),n=parseFloat(r);isNaN(n)||(t+=n)});const i=t>=1e3?`~${(t/1e3).toFixed(1)}kg`:`${Math.round(t)}g`;e.textContent=i,e.classList.remove("dose-updated"),e.offsetWidth,e.classList.add("dose-updated")}function Z(e){return e.replace(/\{([a-z_]+):(\d+\.?\d*)(!)?\}/g,(t,o,i,a)=>{const r=parseFloat(i),n=K(r);return`<span class="dose-inline" data-base="${r}" data-token-id="${o}"${a?' data-fixed="true"':""}>${n}</span>`})}function K(e){return e===0?"0":e>=10?`${Math.round(e)}`:e>=1?`${Math.round(e*10)/10}`:`${Math.round(e*100)/100}`}let z=null;function Qe(){const e=document.getElementById("sensory-header");if(!e)return;const t=document.getElementById("sensory-chart-container"),o=e.querySelector(".sensory-chevron");if(!t||!o)return;const i=e.getAttribute("data-chart-id"),a=window.__sensoryChartData?.[i];if(!a)return;let r=null;e.addEventListener("click",async()=>{if(t.style.display==="none"||!t.style.display){if(t.style.display="block",o.style.transform="rotate(180deg)",!z)try{const{Chart:v,RadarController:L,RadialLinearScale:S,PointElement:A,LineElement:M,Filler:oe,Tooltip:ie}=await D(async()=>{const{Chart:re,RadarController:ae,RadialLinearScale:ne,PointElement:se,LineElement:ce,Filler:le,Tooltip:de}=await import("./chart-Cns13J0s.js");return{Chart:re,RadarController:ae,RadialLinearScale:ne,PointElement:se,LineElement:ce,Filler:le,Tooltip:de}},[]);v.register(L,S,A,M,oe,ie),z=v}catch(v){console.error("Errore caricamento Chart.js:",v);return}r&&(r.destroy(),r=null);const s=document.getElementById("sensoryChart")?.getContext("2d");if(!s)return;const{labels:l,values:g}=a,f=window.innerWidth<600,y=l.map(v=>f&&v.includes(" ")?v.split(" "):v),d=document.documentElement.getAttribute("data-theme")==="dark",w=d?"rgba(212, 165, 116, 0.8)":"rgba(184, 129, 58, 0.8)",p=d?"rgba(212, 165, 116, 0.2)":"rgba(184, 129, 58, 0.2)",b=d?"rgba(255, 255, 255, 0.1)":"rgba(0, 0, 0, 0.1)",$=d?"#94a3b8":"#64748b";r=new z(s,{type:"radar",data:{labels:y,datasets:[{label:"Valore",data:g,backgroundColor:p,borderColor:w,pointBackgroundColor:w,pointBorderColor:"#fff",pointHoverBackgroundColor:"#fff",pointHoverBorderColor:w,borderWidth:2}]},options:{responsive:!0,maintainAspectRatio:!0,layout:{padding:f?10:20},scales:{r:{min:0,max:10,angleLines:{color:b},grid:{color:b},pointLabels:{color:$,font:{family:"Inter",size:f?10:12,weight:"500"}},ticks:{display:!1,stepSize:2}}},plugins:{legend:{display:!1},tooltip:{backgroundColor:d?"#1e293b":"#fff",titleColor:d?"#f8fafc":"#0f172a",bodyColor:d?"#cbd5e1":"#475569",borderColor:d?"#334155":"#e2e8f0",borderWidth:1,padding:10,displayColors:!1,callbacks:{label:v=>v.formattedValue+" / 10"}}}}})}else t.style.display="none",o.style.transform="rotate(0deg)"})}function Je(){return`
  ...
  `}function Ke(){if(sessionStorage.getItem("intro-shown"))return;if(window.matchMedia("(prefers-reduced-motion: reduce)").matches){sessionStorage.setItem("intro-shown","1");return}D(()=>Promise.resolve({}),__vite__mapDeps([0]));const e=()=>{document.body.insertAdjacentHTML("afterbegin",Ze()),et(),sessionStorage.setItem("intro-shown","1")};document.body?e():document.addEventListener("DOMContentLoaded",e,{once:!0})}function et(){const e=document.getElementById("logo-intro"),t=document.getElementById("logo-intro-logo");if(!e)return;document.documentElement.style.overflow="hidden";const o=setTimeout(()=>{t&&t.classList.add("glowing")},1700);e.addEventListener("animationend",i=>{i.animationName==="introOverlayOut"&&(document.documentElement.style.overflow="",e.classList.add("logo-intro--done"),requestAnimationFrame(()=>e.remove()),clearTimeout(o))}),setTimeout(()=>{document.getElementById("logo-intro")&&(document.documentElement.style.overflow="",e.remove())},5e3)}const ee="?v=f84e5d2e";Ke();document.addEventListener("DOMContentLoaded",()=>{tt(),ot(),it();const e=document.getElementById("current-year");e&&(e.textContent=new Date().getFullYear()),E(),at(),ge({home:st,recipe:Be,category:lt,cottura:async(t,o)=>{const{renderCottura:i}=await D(async()=>{const{renderCottura:a}=await import("./pagina-8ZJRhN3y.js");return{renderCottura:a}},__vite__mapDeps([1,2]));return i(t,o)}}),me()});function tt(){const e=document.getElementById("navbar");if(!e)return;const t=()=>e.classList.toggle("scrolled",window.scrollY>50);window.addEventListener("scroll",t,{passive:!0}),t()}function ot(){const e=document.getElementById("theme-toggle");e&&(e.addEventListener("click",()=>{const o=document.documentElement.getAttribute("data-theme")==="dark"?"light":"dark";e.classList.add("theme-toggle--switching"),setTimeout(()=>e.classList.remove("theme-toggle--switching"),400),document.documentElement.setAttribute("data-theme",o),localStorage.setItem("theme",o)}),window.matchMedia("(prefers-color-scheme: dark)").addEventListener("change",t=>{localStorage.getItem("theme")||document.documentElement.setAttribute("data-theme",t.matches?"dark":"light")}))}function it(){const e=document.getElementById("hamburger"),t=document.getElementById("nav-links");!e||!t||(e.addEventListener("click",()=>{e.classList.toggle("open"),t.classList.toggle("open")}),t.querySelectorAll("a").forEach(o=>{o.addEventListener("click",()=>{e.classList.remove("open"),t.classList.remove("open")})}),document.addEventListener("click",o=>{!e.contains(o.target)&&!t.contains(o.target)&&(e.classList.remove("open"),t.classList.remove("open"))}))}let C=null;function rt(e){const t=new URL(h,window.location.origin),o=i=>!i||/^([a-z]+:|\/\/|\/|#)/i.test(i)?i:new URL(i,t).pathname;e.querySelectorAll("[src], [href], [srcset]").forEach(i=>{["src","href"].forEach(r=>{const n=i.getAttribute(r);n&&i.setAttribute(r,o(n))});const a=i.getAttribute("srcset");a&&i.setAttribute("srcset",a.split(",").map(r=>{const[n,...s]=r.trim().split(/\s+/);return[o(n),...s].join(" ")}).join(", "))})}function te(e,t,o){const i=e.cloneNode(!0);return rt(i),{html:i.innerHTML,title:t,description:o}}function at(){const e=document.getElementById("app");e?.querySelector("#ricette")&&(C=te(e,document.title,document.querySelector('meta[name="description"]')?.getAttribute("content")||""))}async function nt(){if(C)return C;const e=await fetch(h),t=new DOMParser().parseFromString(await e.text(),"text/html"),o=t.getElementById("app");if(!o)throw new Error("index.html non contiene #app");return C=te(o,t.title,t.querySelector('meta[name="description"]')?.getAttribute("content")||""),C}async function st(e){if(!e.querySelector("#ricette"))try{const o=await nt();e.innerHTML=o.html}catch(o){console.error("Impossibile ricostruire la homepage:",o),window.location.assign(h);return}const t=C;if(t){document.title=t.title;const o=document.querySelector('meta[name="description"]');o&&o.setAttribute("content",t.description)}E(),ut(),R()}const k=12,ct=Ee;let m={allRecipes:[],filteredRecipes:[],displayedCount:k,viewMode:"grid",sortType:"az",searchQuery:"",categoryDir:""};async function lt(e,{category:t}){const o=ct[t];if(!o){document.title="Categoria non trovata — Ricettario Lab",e.innerHTML=`
      <div class="container" style="padding: 120px 0; text-align: center;">
        ...
        <p><a href="${h}#ricette" data-link>← Vedi tutte le ricette</a></p>
        ...
        <div class="category-toolbar" id="category-toolbar">
          <div class="category-toolbar__search">
            ...
            <input type="text" class="category-toolbar__search-input" id="category-search"
              placeholder="Cerca tra le ricette di ${_(o.name.toLowerCase())}...">
          </div>
  ...
  `,E();try{const r=await(await fetch(`${h}recipes.json${ee}`)).json();m.allRecipes=r.recipes.filter(l=>l.categoryDir===t||l.category===o.name),m.allRecipes.sort((l,g)=>(l.title||"").localeCompare(g.title||"","it")),m.filteredRecipes=[...m.allRecipes];const n=m.allRecipes.find(l=>l.image);if(n){const l=document.getElementById("category-hero");l&&(l.style.backgroundImage=`url('${h}${n.image}')`)}const s=document.getElementById("recipe-count");s&&(s.innerHTML=`${u("bullseye",16)} ${m.allRecipes.length} ricett${m.allRecipes.length===1?"a":"e"}`),P(),dt(e),R(),T()}catch(a){console.error("Errore caricamento categoria:",a);const r=document.getElementById("category-grid");r&&(r.innerHTML=`<div class="category-empty"><div class="category-empty__icon">${u("prohibited",32)}</div><p>Errore nel caricamento delle ricette.</p></div>`)}}function dt(e){const t=document.getElementById("category-search");let o;t&&t.addEventListener("input",()=>{clearTimeout(o),o=setTimeout(()=>{m.searchQuery=t.value.toLowerCase().trim(),m.displayedCount=k,N(),P()},150)});const i=e.querySelectorAll(".category-toolbar__sort-btn");i.forEach(r=>{r.addEventListener("click",()=>{i.forEach(n=>n.classList.remove("active")),r.classList.add("active"),m.sortType=r.dataset.sort,m.displayedCount=k,N(),P()})});const a=e.querySelectorAll(".view-toggle-btn");a.forEach(r=>{r.addEventListener("click",()=>{a.forEach(s=>s.classList.remove("active")),r.classList.add("active"),m.viewMode=r.dataset.view,localStorage.setItem("catViewMode",m.viewMode);const n=document.getElementById("category-grid");n&&n.classList.toggle("category-grid--list",m.viewMode==="list")})})}function N(){let e=[...m.allRecipes];m.searchQuery&&(e=e.filter(t=>{const o=(t.title||"").toLowerCase(),i=(t.description||"").toLowerCase();return o.includes(m.searchQuery)||i.includes(m.searchQuery)})),m.sortType==="az"?e.sort((t,o)=>(t.title||"").localeCompare(o.title||"","it")):m.sortType==="hydration"&&e.sort((t,o)=>(parseInt(o.hydration)||0)-(parseInt(t.hydration)||0)),m.filteredRecipes=e}function P(){const e=document.getElementById("category-grid"),t=document.getElementById("load-more-container");if(!e)return;const{filteredRecipes:o,displayedCount:i,categoryDir:a}=m,r=o.slice(0,i),n=o.length,s=document.getElementById("results-counter");if(s&&(m.searchQuery?s.innerHTML=`<strong>${n}</strong> risultat${n===1?"o":"i"}`:s.innerHTML=`<strong>${Math.min(i,n)}</strong> di <strong>${n}</strong>`),n===0){e.innerHTML=`
      ...
      </div>`,t&&(t.innerHTML=""),E();return}if(e.innerHTML=r.map((l,g)=>{const f=`${h}ricette/${l.categoryDir||a}/${l.slug}`;return`
      <a href="${_(f)}" class="category-card" data-link
         data-title="${_((l.title||"").toLowerCase())}"
         data-hydration="${parseInt(l.hydration)||0}">
        <div class="category-card__image-wrapper">
          ${l.image?X(`${h}${l.image}`,l.title,"category-card__image","lazy"):""}
        ...
        <div class="category-card__body">
          <h3 class="category-card__title">${c(l.title)}</h3>
        ...
        </div>`,document.getElementById("load-more-btn")?.addEventListener("click",()=>{m.displayedCount+=k,P(),setTimeout(()=>{const y=e.querySelectorAll(".category-card")[i];y&&y.scrollIntoView({behavior:"smooth",block:"center"})},100),T()})}else t.innerHTML="";E(),T()}function pt(e){return Array.from({length:e},()=>`
    ...
    <div class="category-row__carousel-wrapper">
      ...
      <div class="category-row__carousel">
        ${a.map(d=>{const w=d.href.replace(".html","");return`
          <a href="${_(w)}" class="recipe-card--compact" data-link data-title="${_(d.title.toLowerCase())}" data-category="${_(d.category)}">
            <div class="recipe-card--compact__image-wrapper">
              ${d.image?X(d.image,d.title,"recipe-card--compact__image","lazy"):""}
            </div>
